...
func (this *MemberRep) GetLevel(levelVal int) *valueobject.MemberLevel{
	//todo: MemberLevel的值应为  1,2,4,8,16,32,会员存储的值应为 partner_id * LevelValue
	// Member
	return nil
}

// 获取下一个等级
func (this *MemberRep) GetNextLevel(levelVal int) *valueobject.MemberLevel {
