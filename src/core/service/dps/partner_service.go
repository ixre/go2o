...
func (this *partnerService) GetMerchant(partnerId int) (*merchant.MerchantValue, error) {
	pt, err := this._partnerRep.GetMerchant(partnerId)
	if pt != nil {
		v := pt.GetValue()
		return &v, err
	}
...
func (this *partnerService) SaveMerchant(partnerId int, v *merchant.MerchantValue) (int, error) {
	...
	if partnerId > 0 {
		pt, _ = this._partnerRep.GetMerchant(partnerId)
		if pt == nil {
...
// 获取商户的域名
func (this *partnerService) GetMerchantMajorHost(partnerId int) string {
	pt, err := this._partnerRep.GetMerchant(partnerId)
	if err != nil {
...
func (this *partnerService) SaveSiteConf(partnerId int, v *merchant.SiteConf) error {
	pt, _ := this._partnerRep.GetMerchant(partnerId)
	return pt.SaveSiteConf(v)
}

func (this *partnerService) SaveSaleConf(partnerId int, v *merchant.SaleConf) error {
	pt, _ := this._partnerRep.GetMerchant(partnerId)
	return pt.SaveSaleConf(v)
}

func (this *partnerService) GetSaleConf(partnerId int) *merchant.SaleConf {
	pt, err := this._partnerRep.GetMerchant(partnerId)
	if err != nil {
		log.Println("[ Partner][ Service]-", err.Error())
	}
...
func (this *partnerService) GetSiteConf(partnerId int) *merchant.SiteConf {
	pt, err := this._partnerRep.GetMerchant(partnerId)
	if err != nil {
		log.Println("[ Partner][ Service]-", err.Error())
	}
...
func (this *partnerService) GetShopsOfMerchant(partnerId int) []*merchant.ValueShop {
	pt, err := this._partnerRep.GetMerchant(partnerId)
	if err != nil {
		log.Println("[ Partner][ Service]-", err.Error())
	}
...
func (this *partnerService) GetShopValueById(partnerId, shopId int) *merchant.ValueShop {
	pt, err := this._partnerRep.GetMerchant(partnerId)
	if err != nil {
...
func (this *partnerService) SaveShop(partnerId int, v *merchant.ValueShop) (int, error) {
	pt, err := this._partnerRep.GetMerchant(partnerId)
	if err != nil {
...
// 保存API信息
func (this *partnerService) SaveApiInfo(partnerId int, d *merchant.ApiInfo) error {
	pt, _ := this._partnerRep.GetMerchant(partnerId)
	return pt.SaveApiInfo(d)
}

// 获取API接口
func (this *partnerService) GetApiInfo(partnerId int) *merchant.ApiInfo {
	pt, _ := this._partnerRep.GetMerchant(partnerId)
	v := pt.GetApiInfo()
	return &v
}
