...
type messageManagerImpl struct {
	rep mss.IMessageRepo
}

func NewMessageManager(rep mss.IMessageRepo) mss.IMessageManager {
...
func NewMssManager(appUserId int64, rep mss.IMessageRepo) mss.IUserMessageManager {
