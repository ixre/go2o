...
func (this *MssRepo) GetMessageContent(msgId int32) *mss.Content {
	panic("implement me")
}

func (this *MssRepo) GetMessageTo(msgId int32, toUserId int32, toRole int) *mss.To {
	panic("implement me")
}
...
func (this *MssRepo) SaveMailTemplate(*mss.MailTemplate) (int32, error) {
	panic("implement me")
}
