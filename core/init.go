...
func OrmMapping(conn db.Connector) {
	...
	orm.Mapping(promodel.Attr{}, "product_attr")
	orm.Mapping(promodel.AttrItem{}, "product_attr_item")
	orm.Mapping(promodel.Spec{}, "product_spec")
	orm.Mapping(promodel.SpecItem{}, "product_spec_item")
