...
// 获取会员的会员Token
func (ms *memberService)GetToken(memberId int32) (r string, err error) {
    md := module.Get(module.M_MM).(*module.MemberModule)
    return md.GetToken(memberId), nil
}

// 重设会员的会员Token，并返回
func (ms *memberService)ResetToken(memberId int32) (r string, err error) {
