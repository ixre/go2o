...
func main() {
  ...
  client := registry_service.NewRegistryServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "GetRegistries":
    ...
    containerStruct0 := registry_service.NewRegistryServiceGetRegistriesArgs()
  ...
  case "UpdateRegistry":
    ...
    containerStruct0 := registry_service.NewRegistryServiceUpdateRegistryArgs()
  ...
  case "GetRegistryV1":
    ...
    containerStruct0 := registry_service.NewRegistryServiceGetRegistryV1Args()
