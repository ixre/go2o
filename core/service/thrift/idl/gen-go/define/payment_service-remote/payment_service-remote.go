...
func main() {
	...
	case "GetPaymentOrderById":
		...
		tmp0, err190 := (strconv.Atoi(flag.Arg(1)))
		if err190 != nil {
			Usage()
			return
		}
	...
	case "AdjustOrder":
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		argvalue1, err192 := (strconv.ParseFloat(flag.Arg(2), 64))
		if err192 != nil {
			Usage()
			return
		}
	...
	case "DiscountByIntegral":
		...
		tmp0, err195 := (strconv.Atoi(flag.Arg(1)))
		if err195 != nil {
			Usage()
			return
		}
	...
	case "PaymentByWallet":
		...
		tmp0, err198 := (strconv.Atoi(flag.Arg(1)))
		if err198 != nil {
			Usage()
			return
		}
	...
	case "HybridPayment":
		...
		tmp0, err200 := (strconv.Atoi(flag.Arg(1)))
		if err200 != nil {
			Usage()
			return
		}
