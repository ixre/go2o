...
func main() {
	...
	case "UpdateLevel":
		...
		argvalue2 := flag.Arg(3) == "true"
		value2 := argvalue2
		argvalue3, err148 := (strconv.ParseInt(flag.Arg(4), 10, 64))
		if err148 != nil {
			Usage()
			return
		}
	...
	case "GetAddress":
		...
		value0 := argvalue0
		argvalue1, err158 := (strconv.ParseInt(flag.Arg(2), 10, 64))
		if err158 != nil {
			Usage()
			return
		}
	...
	case "ChargeAccount":
		...
		value4 := argvalue4
		argvalue5, err174 := (strconv.ParseFloat(flag.Arg(6), 64))
		if err174 != nil {
			Usage()
			return
		}
		value5 := argvalue5
		argvalue6, err175 := (strconv.ParseInt(flag.Arg(7), 10, 64))
		if err175 != nil {
			Usage()
			return
		}
	...
	case "DiscountAccount":
		...
		argvalue3 := flag.Arg(4)
		value3 := argvalue3
		argvalue4, err180 := (strconv.ParseFloat(flag.Arg(5), 64))
		if err180 != nil {
			Usage()
			return
		}
		value4 := argvalue4
		argvalue5, err181 := (strconv.ParseInt(flag.Arg(6), 10, 64))
		if err181 != nil {
			Usage()
			return
		}
