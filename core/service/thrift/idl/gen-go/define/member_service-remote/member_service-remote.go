...
func main() {
	...
	case "Premium":
		...
		value1 := argvalue1
		argvalue2, err64 := (strconv.ParseInt(flag.Arg(3), 10, 64))
		if err64 != nil {
			Usage()
			return
		}
	...
	case "ChargeAccount":
		...
		value4 := argvalue4
		argvalue5, err80 := (strconv.ParseFloat(flag.Arg(6), 64))
		if err80 != nil {
			Usage()
			return
		}
		value5 := argvalue5
		argvalue6, err81 := (strconv.ParseInt(flag.Arg(7), 10, 64))
		if err81 != nil {
			Usage()
			return
		}
	...
	case "DiscountAccount":
		...
		argvalue3 := flag.Arg(4)
		value3 := argvalue3
		argvalue4, err86 := (strconv.ParseFloat(flag.Arg(5), 64))
		if err86 != nil {
			Usage()
			return
		}
		value4 := argvalue4
		argvalue5, err87 := (strconv.ParseInt(flag.Arg(6), 10, 64))
		if err87 != nil {
			Usage()
			return
		}
