...
func main() {
	...
	case "Premium":
		...
		value1 := argvalue1
		argvalue2, err111 := (strconv.ParseInt(flag.Arg(3), 10, 64))
		if err111 != nil {
			Usage()
			return
		}
	...
	case "GetAddress":
		...
		value0 := argvalue0
		argvalue1, err118 := (strconv.ParseInt(flag.Arg(2), 10, 64))
		if err118 != nil {
			Usage()
			return
		}
	...
	case "ChargeAccount":
		...
		value0 := argvalue0
		tmp1, err126 := (strconv.Atoi(flag.Arg(2)))
		if err126 != nil {
			Usage()
			return
		}
		argvalue1 := int32(tmp1)
		value1 := argvalue1
		tmp2, err127 := (strconv.Atoi(flag.Arg(3)))
		if err127 != nil {
			Usage()
			return
		}
		...
		value4 := argvalue4
		argvalue5, err130 := (strconv.ParseFloat(flag.Arg(6), 64))
		if err130 != nil {
			Usage()
			return
		}
		value5 := argvalue5
		argvalue6, err131 := (strconv.ParseInt(flag.Arg(7), 10, 64))
		if err131 != nil {
			Usage()
			return
		}
	...
	case "DiscountAccount":
		...
		argvalue3 := flag.Arg(4)
		value3 := argvalue3
		argvalue4, err136 := (strconv.ParseFloat(flag.Arg(5), 64))
		if err136 != nil {
			Usage()
			return
		}
		value4 := argvalue4
		argvalue5, err137 := (strconv.ParseInt(flag.Arg(6), 10, 64))
		if err137 != nil {
			Usage()
			return
		}
