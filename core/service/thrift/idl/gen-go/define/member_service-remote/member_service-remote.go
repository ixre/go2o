...
func main() {
	...
	case "Premium":
		...
		value1 := argvalue1
		argvalue2, err45 := (strconv.ParseInt(flag.Arg(3), 10, 64))
		if err45 != nil {
			Usage()
			return
		}
	...
	case "ChargeAccount":
		...
		value4 := argvalue4
		argvalue5, err61 := (strconv.ParseFloat(flag.Arg(6), 64))
		if err61 != nil {
			Usage()
			return
		}
		value5 := argvalue5
		tmp6, err62 := (strconv.Atoi(flag.Arg(7)))
		if err62 != nil {
			Usage()
			return
		}
	...
	case "DiscountAccount":
		...
		argvalue3 := flag.Arg(4)
		value3 := argvalue3
		argvalue4, err67 := (strconv.ParseFloat(flag.Arg(5), 64))
		if err67 != nil {
			Usage()
			return
		}
		value4 := argvalue4
		tmp5, err68 := (strconv.Atoi(flag.Arg(6)))
		if err68 != nil {
			Usage()
			return
		}
