...
func main() {
	...
	case "Premium":
		...
		value1 := argvalue1
		argvalue2, err138 := (strconv.ParseInt(flag.Arg(3), 10, 64))
		if err138 != nil {
			Usage()
			return
		}
	...
	case "ChargeAccount":
		...
		value4 := argvalue4
		argvalue5, err161 := (strconv.ParseFloat(flag.Arg(6), 64))
		if err161 != nil {
			Usage()
			return
		}
		value5 := argvalue5
		argvalue6, err162 := (strconv.ParseInt(flag.Arg(7), 10, 64))
		if err162 != nil {
			Usage()
			return
		}
	...
	case "DiscountAccount":
		...
		argvalue3 := flag.Arg(4)
		value3 := argvalue3
		argvalue4, err167 := (strconv.ParseFloat(flag.Arg(5), 64))
		if err167 != nil {
			Usage()
			return
		}
		value4 := argvalue4
		argvalue5, err168 := (strconv.ParseInt(flag.Arg(6), 10, 64))
		if err168 != nil {
			Usage()
			return
		}
