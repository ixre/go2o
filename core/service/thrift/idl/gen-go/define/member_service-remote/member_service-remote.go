...
func main() {
	...
	case "Premium":
		...
		value1 := argvalue1
		argvalue2, err57 := (strconv.ParseInt(flag.Arg(3), 10, 64))
		if err57 != nil {
			Usage()
			return
		}
	...
	case "ChargeAccount":
		...
		value4 := argvalue4
		argvalue5, err73 := (strconv.ParseFloat(flag.Arg(6), 64))
		if err73 != nil {
			Usage()
			return
		}
		value5 := argvalue5
		argvalue6, err74 := (strconv.ParseInt(flag.Arg(7), 10, 64))
		if err74 != nil {
			Usage()
			return
		}
	...
	case "DiscountAccount":
		...
		value0 := argvalue0
		tmp1, err76 := (strconv.Atoi(flag.Arg(2)))
		if err76 != nil {
			Usage()
			return
		}
		...
		argvalue3 := flag.Arg(4)
		value3 := argvalue3
		argvalue4, err79 := (strconv.ParseFloat(flag.Arg(5), 64))
		if err79 != nil {
			Usage()
			return
		}
		value4 := argvalue4
		argvalue5, err80 := (strconv.ParseInt(flag.Arg(6), 10, 64))
		if err80 != nil {
			Usage()
			return
		}
