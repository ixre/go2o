...
func main() {
	...
	case "Premium":
		...
		value1 := argvalue1
		argvalue2, err94 := (strconv.ParseInt(flag.Arg(3), 10, 64))
		if err94 != nil {
			Usage()
			return
		}
	...
	case "ChargeAccount":
		...
		value4 := argvalue4
		argvalue5, err110 := (strconv.ParseFloat(flag.Arg(6), 64))
		if err110 != nil {
			Usage()
			return
		}
		value5 := argvalue5
		argvalue6, err111 := (strconv.ParseInt(flag.Arg(7), 10, 64))
		if err111 != nil {
			Usage()
			return
		}
	...
	case "DiscountAccount":
		...
		argvalue3 := flag.Arg(4)
		value3 := argvalue3
		argvalue4, err116 := (strconv.ParseFloat(flag.Arg(5), 64))
		if err116 != nil {
			Usage()
			return
		}
