...
func main() {
	...
	case "InviterArray":
		...
		value0 := argvalue0
		tmp1, err116 := (strconv.Atoi(flag.Arg(2)))
		if err116 != nil {
			Usage()
			return
		}
	...
	case "GetInviterQuantity":
		...
		argvalue1 := int32(tmp1)
		value1 := argvalue1
		argvalue2, err119 := (strconv.ParseInt(flag.Arg(3), 10, 64))
		if err119 != nil {
			Usage()
			return
		}
	...
	case "ChargeAccount":
		...
		value4 := argvalue4
		argvalue5, err125 := (strconv.ParseFloat(flag.Arg(6), 64))
		if err125 != nil {
			Usage()
			return
		}
		value5 := argvalue5
		argvalue6, err126 := (strconv.ParseInt(flag.Arg(7), 10, 64))
		if err126 != nil {
			Usage()
			return
		}
	...
	case "DiscountAccount":
		...
		argvalue3 := flag.Arg(4)
		value3 := argvalue3
		argvalue4, err131 := (strconv.ParseFloat(flag.Arg(5), 64))
		if err131 != nil {
			Usage()
			return
		}
		value4 := argvalue4
		argvalue5, err132 := (strconv.ParseInt(flag.Arg(6), 10, 64))
		if err132 != nil {
			Usage()
			return
		}
