...
type ItemService interface {
  ...
  //  - ItemId
  //  - SkuId
  GetSku(ctx context.Context, itemId int64, skuId int64) (r *Sku, err error)
  // Parameters:
  //  - ItemId
...
// Deprecated: Use NewItemService instead
...
//  - ItemId
//  - SkuId
func (p *ItemServiceClient) GetSku(ctx context.Context, itemId int64, skuId int64) (r *Sku, err error) {
  var _args0 ItemServiceGetSkuArgs
  _args0.ItemId = itemId
  _args0.SkuId = skuId
  var _result1 ItemServiceGetSkuResult
  if err = p.c.Call(ctx, "GetSku", &_args0, &_result1); err != nil {
    return
  }
...
func (p *ItemServiceClient) GetItemSkuJson(ctx context.Context, itemId int64) (r string, err error) {
  ...
  if err = p.c.Call(ctx, "GetItemSkuJson", &_args2, &_result3); err != nil {
    return
  }
...
func (p *ItemServiceClient) GetItemDetailData(ctx context.Context, itemId int64, iType int32) (r string, err error) {
  ...
  if err = p.c.Call(ctx, "GetItemDetailData", &_args4, &_result5); err != nil {
    return
  }
...
type ItemServiceGetSkuResult struct {
  Success *Sku `thrift:"success,0" db:"success" json:"success,omitempty"`
}
