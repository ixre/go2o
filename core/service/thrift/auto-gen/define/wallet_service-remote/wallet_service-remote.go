...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  PagingResult PagingWalletLog(i64 walletId, PagingParams params)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := define.NewWalletServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "PagingWalletLog":
    ...
    argvalue1 := define.NewPagingParams()
