...
func main() {
  ...
  client := define.NewFoundationServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "GetRegistryMapV1":
    ...
    argvalue0 := containerStruct0.Keys
    value0 := argvalue0
    fmt.Print(client.GetRegistryMapV1(context.Background(), value0))
    fmt.Print("\n")
    break
  ...
  case "GetAreaNames":
    ...
    containerStruct0 := define.NewFoundationServiceGetAreaNamesArgs()
