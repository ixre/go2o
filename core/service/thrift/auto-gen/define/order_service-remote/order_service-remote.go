...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  Result64 SubmitTradeOrder(SComplexOrder o, double rate)")
...
func main() {
  ...
  client := define.NewOrderServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "WholesaleCartV1":
    ...
    containerStruct2 := define.NewOrderServiceWholesaleCartV1Args()
  ...
  case "RetailCartV1":
    ...
    containerStruct2 := define.NewOrderServiceRetailCartV1Args()
  ...
  case "SubmitOrderV1":
    ...
    containerStruct2 := define.NewOrderServiceSubmitOrderV1Args()
  ...
  case "SubmitTradeOrder":
    ...
    argvalue0 := define.NewSComplexOrder()
    err74 := argvalue0.Read(jsProt73)
    if err74 != nil {
      Usage()
      return
    }
    value0 := define.SComplexOrder(argvalue0)
