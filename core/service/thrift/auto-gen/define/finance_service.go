...
type FinanceService interface {
  ...
  //  - TransferWith
  //  - Amount
  RiseTransferIn(ctx context.Context, personId int64, transferWith int32, amount float64) (r *DResult_, err error)
}
...
// Deprecated: Use NewFinanceService instead
...
//  - TransferWith
//  - Amount
func (p *FinanceServiceClient) RiseTransferIn(ctx context.Context, personId int64, transferWith int32, amount float64) (r *DResult_, err error) {
  ...
  if err = p.c.Call(ctx, "RiseTransferIn", &_args0, &_result1); err != nil {
    return
  }
...
var FinanceServiceRiseTransferInResult_Success_DEFAULT *DResult_
func (p *FinanceServiceRiseTransferInResult) GetSuccess() *DResult_ {
  if !p.IsSetSuccess() {
