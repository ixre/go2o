...
type ShopService interface {
  // Parameters:
  //  - VenderId
  GetStore(ctx context.Context, venderId int32) (r *Store, err error)
  // Parameters:
  //  - ShopId
  GetStoreById(ctx context.Context, shopId int32) (r *Store, err error)
  // Parameters:
  //  - ShopId
  //  - On
  //  - Reason
  TurnShop(ctx context.Context, shopId int32, on bool, reason string) (r *Result_, err error)
  // Parameters:
  //  - ShopId
  //  - Opening
  //  - Reason
  OpenShop(ctx context.Context, shopId int32, opening bool, reason string) (r *Result_, err error)
}
...
// Parameters:
//  - VenderId
func (p *ShopServiceClient) GetStore(ctx context.Context, venderId int32) (r *Store, err error) {
...
// Parameters:
//  - ShopId
func (p *ShopServiceClient) GetStoreById(ctx context.Context, shopId int32) (r *Store, err error) {
...
//  - On
//  - Reason
func (p *ShopServiceClient) TurnShop(ctx context.Context, shopId int32, on bool, reason string) (r *Result_, err error) {
...
//  - Opening
//  - Reason
func (p *ShopServiceClient) OpenShop(ctx context.Context, shopId int32, opening bool, reason string) (r *Result_, err error) {
