...
type OrderService interface {
  ...
  //  - Action
  //  - Data
  WholesaleCartV1(ctx context.Context, memberId int64, action string, data map[string]string) (r *Result_, err error)
  // Parameters:
  //  - MemberId
  //  - Action
  //  - Data
  RetailCartV1(ctx context.Context, memberId int64, action string, data map[string]string) (r *Result_, err error)
  // Parameters:
  //  - BuyerId
  //  - CartType
  //  - Data
  ...
  //  - O
  //  - Rate
  SubmitTradeOrder(ctx context.Context, o *SComplexOrder, rate float64) (r *Result64, err error)
  // Parameters:
  //  - OrderId
  TradeOrderCashPay(ctx context.Context, orderId int64) (r *Result64, err error)
  // Parameters:
  //  - OrderId
  //  - Img
  TradeOrderUpdateTicket(ctx context.Context, orderId int64, img string) (r *Result64, err error)
}
...
//  - Action
//  - Data
func (p *OrderServiceClient) WholesaleCartV1(ctx context.Context, memberId int64, action string, data map[string]string) (r *Result_, err error) {
  ...
  if err = p.c.Call(ctx, "WholesaleCartV1", &_args5, &_result6); err != nil {
    return
  }
...
//  - Action
//  - Data
func (p *OrderServiceClient) RetailCartV1(ctx context.Context, memberId int64, action string, data map[string]string) (r *Result_, err error) {
  var _args7 OrderServiceRetailCartV1Args
  _args7.MemberId = memberId
  _args7.Action = action
  _args7.Data = data
  var _result8 OrderServiceRetailCartV1Result
  if err = p.c.Call(ctx, "RetailCartV1", &_args7, &_result8); err != nil {
    return
  }
...
func (p *OrderServiceClient) SubmitOrderV1(ctx context.Context, buyerId int64, cartType int32, data map[string]string) (r map[string]string, err error) {
  ...
  if err = p.c.Call(ctx, "SubmitOrderV1", &_args9, &_result10); err != nil {
    return
  }
...
func (p *OrderServiceClient) GetOrder(ctx context.Context, order_no string, sub_order bool) (r *SComplexOrder, err error) {
  ...
  if err = p.c.Call(ctx, "GetOrder", &_args11, &_result12); err != nil {
    return
  }
...
func (p *OrderServiceClient) GetOrderAndItems(ctx context.Context, order_no string, sub_order bool) (r *SComplexOrder, err error) {
  ...
  if err = p.c.Call(ctx, "GetOrderAndItems", &_args13, &_result14); err != nil {
    return
  }
...
func (p *OrderServiceClient) GetSubOrder(ctx context.Context, id int64) (r *SComplexOrder, err error) {
  ...
  if err = p.c.Call(ctx, "GetSubOrder", &_args15, &_result16); err != nil {
    return
  }
...
func (p *OrderServiceClient) GetSubOrderByNo(ctx context.Context, orderNo string) (r *SComplexOrder, err error) {
  ...
  if err = p.c.Call(ctx, "GetSubOrderByNo", &_args17, &_result18); err != nil {
    return
  }
...
func (p *OrderServiceClient) GetSubOrderItems(ctx context.Context, subOrderId int64) (r []*SComplexItem, err error) {
  ...
  if err = p.c.Call(ctx, "GetSubOrderItems", &_args19, &_result20); err != nil {
    return
  }
...
//  - O
//  - Rate
func (p *OrderServiceClient) SubmitTradeOrder(ctx context.Context, o *SComplexOrder, rate float64) (r *Result64, err error) {
  var _args21 OrderServiceSubmitTradeOrderArgs
  _args21.O = o
  _args21.Rate = rate
  var _result22 OrderServiceSubmitTradeOrderResult
  if err = p.c.Call(ctx, "SubmitTradeOrder", &_args21, &_result22); err != nil {
    return
  }
...
// Parameters:
//  - OrderId
func (p *OrderServiceClient) TradeOrderCashPay(ctx context.Context, orderId int64) (r *Result64, err error) {
  var _args23 OrderServiceTradeOrderCashPayArgs
  _args23.OrderId = orderId
  var _result24 OrderServiceTradeOrderCashPayResult
  if err = p.c.Call(ctx, "TradeOrderCashPay", &_args23, &_result24); err != nil {
    return
  }
...
//  - OrderId
//  - Img
func (p *OrderServiceClient) TradeOrderUpdateTicket(ctx context.Context, orderId int64, img string) (r *Result64, err error) {
  ...
  if err = p.c.Call(ctx, "TradeOrderUpdateTicket", &_args25, &_result26); err != nil {
    return
  }
...
func NewOrderServiceProcessor(handler OrderService) *OrderServiceProcessor {
  ...
  self27.processorMap["RetailCartV1"] = &orderServiceProcessorRetailCartV1{handler:handler}
...
type orderServiceProcessorRetailCartV1 struct {
  handler OrderService
}

func (p *orderServiceProcessorRetailCartV1) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := OrderServiceRetailCartV1Args{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
  ...
  iprot.ReadMessageEnd()
  result := OrderServiceRetailCartV1Result{}
var retval *Result_
  var err2 error
  if retval, err2 = p.handler.RetailCartV1(ctx, args.MemberId, args.Action, args.Data); err2 != nil {
...
var OrderServiceWholesaleCartV1Result_Success_DEFAULT *Result_
func (p *OrderServiceWholesaleCartV1Result) GetSuccess() *Result_ {
  if !p.IsSetSuccess() {
...
//  - Action
//  - Data
type OrderServiceRetailCartV1Args struct {
  MemberId int64 `thrift:"memberId,1" db:"memberId" json:"memberId"`
  Action string `thrift:"action,2" db:"action" json:"action"`
  Data map[string]string `thrift:"data,3" db:"data" json:"data"`
}

func NewOrderServiceRetailCartV1Args() *OrderServiceRetailCartV1Args {
  return &OrderServiceRetailCartV1Args{}
}


func (p *OrderServiceRetailCartV1Args) GetMemberId() int64 {
  return p.MemberId
}

func (p *OrderServiceRetailCartV1Args) GetAction() string {
  return p.Action
}

func (p *OrderServiceRetailCartV1Args) GetData() map[string]string {
  return p.Data
}
func (p *OrderServiceRetailCartV1Args) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *OrderServiceRetailCartV1Args)  ReadField1(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  p.MemberId = v
...
func (p *OrderServiceRetailCartV1Args)  ReadField2(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.Action = v
...
func (p *OrderServiceRetailCartV1Args)  ReadField3(iprot thrift.TProtocol) error {
  _, _, size, err := iprot.ReadMapBegin()
  if err != nil {
    return thrift.PrependError("error reading map begin: ", err)
  }
...
func (p *OrderServiceRetailCartV1Args) Write(oprot thrift.TProtocol) error {
...
func (p *OrderServiceRetailCartV1Args) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("memberId", thrift.I64, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:memberId: ", p), err) }
  if err := oprot.WriteI64(int64(p.MemberId)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.memberId (1) field write error: ", p), err) }
...
func (p *OrderServiceRetailCartV1Args) writeField2(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("action", thrift.STRING, 2); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:action: ", p), err) }
  if err := oprot.WriteString(string(p.Action)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.action (2) field write error: ", p), err) }
...
func (p *OrderServiceRetailCartV1Args) writeField3(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("data", thrift.MAP, 3); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:data: ", p), err) }
  if err := oprot.WriteMapBegin(thrift.STRING, thrift.STRING, len(p.Data)); err != nil {
    return thrift.PrependError("error writing map begin: ", err)
...
func (p *OrderServiceRetailCartV1Args) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("OrderServiceRetailCartV1Args(%+v)", *p)
}

// Attributes:
//  - Success
type OrderServiceRetailCartV1Result struct {
  Success *Result_ `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewOrderServiceRetailCartV1Result() *OrderServiceRetailCartV1Result {
  return &OrderServiceRetailCartV1Result{}
}

var OrderServiceRetailCartV1Result_Success_DEFAULT *Result_
func (p *OrderServiceRetailCartV1Result) GetSuccess() *Result_ {
  if !p.IsSetSuccess() {
    return OrderServiceRetailCartV1Result_Success_DEFAULT
  }
return p.Success
}
func (p *OrderServiceRetailCartV1Result) IsSetSuccess() bool {
  return p.Success != nil
}

func (p *OrderServiceRetailCartV1Result) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *OrderServiceRetailCartV1Result)  ReadField0(iprot thrift.TProtocol) error {
  p.Success = &Result_{}
  if err := p.Success.Read(iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Success), err)
  }
...
func (p *OrderServiceRetailCartV1Result) Write(oprot thrift.TProtocol) error {
...
func (p *OrderServiceRetailCartV1Result) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
    if err := oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err) }
    if err := p.Success.Write(oprot); err != nil {
...
func (p *OrderServiceRetailCartV1Result) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("OrderServiceRetailCartV1Result(%+v)", *p)
}
...
var OrderServiceSubmitTradeOrderResult_Success_DEFAULT *Result64
func (p *OrderServiceSubmitTradeOrderResult) GetSuccess() *Result64 {
  if !p.IsSetSuccess() {
...
var OrderServiceTradeOrderCashPayResult_Success_DEFAULT *Result64
func (p *OrderServiceTradeOrderCashPayResult) GetSuccess() *Result64 {
  if !p.IsSetSuccess() {
...
var OrderServiceTradeOrderUpdateTicketResult_Success_DEFAULT *Result64
func (p *OrderServiceTradeOrderUpdateTicketResult) GetSuccess() *Result64 {
  if !p.IsSetSuccess() {
