...
type MerchantService interface {
  // Parameters:
  //  - MchId
  Complex(ctx context.Context, mchId int32) (r *ComplexMerchant, err error)
  // Parameters:
  //  - Usr
  //  - OriPwd
  CheckLogin(ctx context.Context, usr string, oriPwd string) (r *Result_, err error)
  // Parameters:
  //  - MchId
  Stat(ctx context.Context, mchId int32) (r *Result_, err error)
  // Parameters:
  //  - MchId
  ...
  //  - MchId
  //  - Arr
  SaveTradeConf(ctx context.Context, mchId int32, arr []*STradeConf) (r *Result_, err error)
}
...
// Deprecated: Use NewMerchantService instead
...
// Parameters:
//  - MchId
func (p *MerchantServiceClient) Complex(ctx context.Context, mchId int32) (r *ComplexMerchant, err error) {
  var _args0 MerchantServiceComplexArgs
  _args0.MchId = mchId
  var _result1 MerchantServiceComplexResult
  if err = p.c.Call(ctx, "Complex", &_args0, &_result1); err != nil {
    return
  }
...
//  - Usr
//  - OriPwd
func (p *MerchantServiceClient) CheckLogin(ctx context.Context, usr string, oriPwd string) (r *Result_, err error) {
...
// Parameters:
//  - MchId
func (p *MerchantServiceClient) Stat(ctx context.Context, mchId int32) (r *Result_, err error) {
  var _args4 MerchantServiceStatArgs
  _args4.MchId = mchId
  var _result5 MerchantServiceStatResult
  if err = p.c.Call(ctx, "Stat", &_args4, &_result5); err != nil {
    return
  }
...
func (p *MerchantServiceClient) SyncWholesaleItem(ctx context.Context, mchId int32) (r map[string]int32, err error) {
  ...
  if err = p.c.Call(ctx, "SyncWholesaleItem", &_args6, &_result7); err != nil {
    return
  }
...
func (p *MerchantServiceClient) GetAllTradeConf(ctx context.Context, mchId int32) (r []*STradeConf, err error) {
  ...
  if err = p.c.Call(ctx, "GetAllTradeConf", &_args8, &_result9); err != nil {
    return
  }
...
func (p *MerchantServiceClient) GetTradeConf(ctx context.Context, mchId int32, tradeType int32) (r *STradeConf, err error) {
  ...
  if err = p.c.Call(ctx, "GetTradeConf", &_args10, &_result11); err != nil {
    return
  }
...
//  - MchId
//  - Arr
func (p *MerchantServiceClient) SaveTradeConf(ctx context.Context, mchId int32, arr []*STradeConf) (r *Result_, err error) {
  var _args12 MerchantServiceSaveTradeConfArgs
  _args12.MchId = mchId
  _args12.Arr = arr
  var _result13 MerchantServiceSaveTradeConfResult
  if err = p.c.Call(ctx, "SaveTradeConf", &_args12, &_result13); err != nil {
    return
  }
...
var MerchantServiceSaveTradeConfResult_Success_DEFAULT *Result_
func (p *MerchantServiceSaveTradeConfResult) GetSuccess() *Result_ {
  if !p.IsSetSuccess() {
