...
type WalletService interface {  //钱包服务
  ...
  //  - Flag
  //  - Remark
  CreateWallet(ctx context.Context, userId int64, walletType int32, flag int32, remark string) (r *Result_, err error)
  // 获取钱包编号，如果钱包不存在，则返回0
  // 
  // Parameters:
  //  - UserId
  ...
  //  - OpuId
  //  - OpuName
  Adjust(ctx context.Context, walletId int64, value int32, title string, outerNo string, opuId int32, opuName string) (r *Result_, err error)
  // 支付抵扣,must是否必须大于0
  // 
  // Parameters:
  //  - WalletId
  ...
  //  - OuterNo
  //  - Must
  Discount(ctx context.Context, walletId int64, value int32, title string, outerNo string, must bool) (r *Result_, err error)
  // 冻结余额
  // 
  // Parameters:
  //  - WalletId
  ...
  //  - OpuId
  //  - OpuName
  Freeze(ctx context.Context, walletId int64, value int32, title string, outerNo string, opuId int32, opuName string) (r *Result_, err error)
  // 解冻金额
  // 
  // Parameters:
  //  - WalletId
  ...
  //  - OpuId
  //  - OpuName
  Unfreeze(ctx context.Context, walletId int64, value int32, title string, outerNo string, opuId int32, opuName string) (r *Result_, err error)
  // 充值,kind: 业务类型
  // 
  // Parameters:
  //  - WalletId
  ...
  //  - OpuId
  //  - OpuName
  Charge(ctx context.Context, walletId int64, value int32, by int32, title string, outerNo string, opuId int32, opuName string) (r *Result_, err error)
  ...
  //  - TradeFee
  //  - Remark
  Transfer(ctx context.Context, walletId int64, toWalletId int64, value int32, tradeFee int32, remark string) (r *Result_, err error)
  ...
  //  - Kind
  //  - Title
  RequestTakeOut(ctx context.Context, walletId int64, value int32, tradeFee int32, kind int32, title string) (r *Result_, err error)
  // 确认提现
  // 
  // Parameters:
  //  - WalletId
  ...
  //  - OpuId
  //  - OpuName
  ReviewTakeOut(ctx context.Context, walletId int64, takeId int64, reviewPass bool, remark string, opuId int32, opuName string) (r *Result_, err error)
  // 完成提现
  // 
  // Parameters:
  //  - WalletId
  //  - TakeId
  //  - OuterNo
  FinishTakeOut(ctx context.Context, walletId int64, takeId int64, outerNo string) (r *Result_, err error)
  // 获取分页钱包日志
  // 
  // Parameters:
  //  - WalletId
  //  - Params
  PagingWalletLog(ctx context.Context, walletId int64, params *PagingParams) (r *PagingResult_, err error)
}
...
// Deprecated: Use NewWalletService instead
...
//  - Flag
//  - Remark
func (p *WalletServiceClient) CreateWallet(ctx context.Context, userId int64, walletType int32, flag int32, remark string) (r *Result_, err error) {
  ...
  if err = p.c.Call(ctx, "CreateWallet", &_args0, &_result1); err != nil {
    return
  }
...
func (p *WalletServiceClient) GetWalletId(ctx context.Context, userId int64, walletType int32) (r int64, err error) {
  ...
  if err = p.c.Call(ctx, "GetWalletId", &_args2, &_result3); err != nil {
    return
  }
...
func (p *WalletServiceClient) GetWallet(ctx context.Context, walletId int64) (r *SWallet, err error) {
  ...
  if err = p.c.Call(ctx, "GetWallet", &_args4, &_result5); err != nil {
    return
  }
...
func (p *WalletServiceClient) GetWalletLog(ctx context.Context, walletId int64, id int64) (r *SWalletLog, err error) {
  ...
  if err = p.c.Call(ctx, "GetWalletLog", &_args6, &_result7); err != nil {
    return
  }
...
//  - OpuId
//  - OpuName
func (p *WalletServiceClient) Adjust(ctx context.Context, walletId int64, value int32, title string, outerNo string, opuId int32, opuName string) (r *Result_, err error) {
  ...
  if err = p.c.Call(ctx, "Adjust", &_args8, &_result9); err != nil {
    return
  }
...
//  - OuterNo
//  - Must
func (p *WalletServiceClient) Discount(ctx context.Context, walletId int64, value int32, title string, outerNo string, must bool) (r *Result_, err error) {
  ...
  if err = p.c.Call(ctx, "Discount", &_args10, &_result11); err != nil {
    return
  }
...
//  - OpuId
//  - OpuName
func (p *WalletServiceClient) Freeze(ctx context.Context, walletId int64, value int32, title string, outerNo string, opuId int32, opuName string) (r *Result_, err error) {
  ...
  if err = p.c.Call(ctx, "Freeze", &_args12, &_result13); err != nil {
    return
  }
...
//  - OpuId
//  - OpuName
func (p *WalletServiceClient) Unfreeze(ctx context.Context, walletId int64, value int32, title string, outerNo string, opuId int32, opuName string) (r *Result_, err error) {
  ...
  if err = p.c.Call(ctx, "Unfreeze", &_args14, &_result15); err != nil {
    return
  }
...
//  - OpuId
//  - OpuName
func (p *WalletServiceClient) Charge(ctx context.Context, walletId int64, value int32, by int32, title string, outerNo string, opuId int32, opuName string) (r *Result_, err error) {
  ...
  if err = p.c.Call(ctx, "Charge", &_args16, &_result17); err != nil {
    return
  }
...
//  - TradeFee
//  - Remark
func (p *WalletServiceClient) Transfer(ctx context.Context, walletId int64, toWalletId int64, value int32, tradeFee int32, remark string) (r *Result_, err error) {
  ...
  if err = p.c.Call(ctx, "Transfer", &_args18, &_result19); err != nil {
    return
  }
...
//  - Kind
//  - Title
func (p *WalletServiceClient) RequestTakeOut(ctx context.Context, walletId int64, value int32, tradeFee int32, kind int32, title string) (r *Result_, err error) {
  ...
  if err = p.c.Call(ctx, "RequestTakeOut", &_args20, &_result21); err != nil {
    return
  }
...
//  - OpuId
//  - OpuName
func (p *WalletServiceClient) ReviewTakeOut(ctx context.Context, walletId int64, takeId int64, reviewPass bool, remark string, opuId int32, opuName string) (r *Result_, err error) {
  ...
  if err = p.c.Call(ctx, "ReviewTakeOut", &_args22, &_result23); err != nil {
    return
  }
...
//  - TakeId
//  - OuterNo
func (p *WalletServiceClient) FinishTakeOut(ctx context.Context, walletId int64, takeId int64, outerNo string) (r *Result_, err error) {
  ...
  if err = p.c.Call(ctx, "FinishTakeOut", &_args24, &_result25); err != nil {
    return
  }
...
//  - WalletId
//  - Params
func (p *WalletServiceClient) PagingWalletLog(ctx context.Context, walletId int64, params *PagingParams) (r *PagingResult_, err error) {
  ...
  if err = p.c.Call(ctx, "PagingWalletLog", &_args26, &_result27); err != nil {
    return
  }
...
var WalletServiceCreateWalletResult_Success_DEFAULT *Result_
func (p *WalletServiceCreateWalletResult) GetSuccess() *Result_ {
  if !p.IsSetSuccess() {
...
var WalletServiceAdjustResult_Success_DEFAULT *Result_
func (p *WalletServiceAdjustResult) GetSuccess() *Result_ {
  if !p.IsSetSuccess() {
...
var WalletServiceDiscountResult_Success_DEFAULT *Result_
func (p *WalletServiceDiscountResult) GetSuccess() *Result_ {
  if !p.IsSetSuccess() {
...
var WalletServiceFreezeResult_Success_DEFAULT *Result_
func (p *WalletServiceFreezeResult) GetSuccess() *Result_ {
  if !p.IsSetSuccess() {
...
var WalletServiceUnfreezeResult_Success_DEFAULT *Result_
func (p *WalletServiceUnfreezeResult) GetSuccess() *Result_ {
  if !p.IsSetSuccess() {
...
var WalletServiceChargeResult_Success_DEFAULT *Result_
func (p *WalletServiceChargeResult) GetSuccess() *Result_ {
  if !p.IsSetSuccess() {
...
var WalletServiceTransferResult_Success_DEFAULT *Result_
func (p *WalletServiceTransferResult) GetSuccess() *Result_ {
  if !p.IsSetSuccess() {
...
var WalletServiceRequestTakeOutResult_Success_DEFAULT *Result_
func (p *WalletServiceRequestTakeOutResult) GetSuccess() *Result_ {
  if !p.IsSetSuccess() {
...
var WalletServiceReviewTakeOutResult_Success_DEFAULT *Result_
func (p *WalletServiceReviewTakeOutResult) GetSuccess() *Result_ {
  if !p.IsSetSuccess() {
...
var WalletServiceFinishTakeOutResult_Success_DEFAULT *Result_
func (p *WalletServiceFinishTakeOutResult) GetSuccess() *Result_ {
  if !p.IsSetSuccess() {
...
type WalletServicePagingWalletLogArgs struct {
  WalletId int64 `thrift:"walletId,1" db:"walletId" json:"walletId"`
  Params *PagingParams `thrift:"params,2" db:"params" json:"params"`
}
...
var WalletServicePagingWalletLogArgs_Params_DEFAULT *PagingParams
func (p *WalletServicePagingWalletLogArgs) GetParams() *PagingParams {
  if !p.IsSetParams() {
...
type WalletServicePagingWalletLogResult struct {
  Success *PagingResult_ `thrift:"success,0" db:"success" json:"success,omitempty"`
}
...
var WalletServicePagingWalletLogResult_Success_DEFAULT *PagingResult_
func (p *WalletServicePagingWalletLogResult) GetSuccess() *PagingResult_ {
  if !p.IsSetSuccess() {
