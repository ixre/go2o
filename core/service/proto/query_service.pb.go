...
func (*FavoriteQueryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_query_service_45310e7e22fba0ea, []int{0}
}
...
func (*PagingShopFavoriteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_query_service_45310e7e22fba0ea, []int{1}
}
...
func (*SPagingShopFavorite) Descriptor() ([]byte, []int) {
	return fileDescriptor_query_service_45310e7e22fba0ea, []int{2}
}
...
func (*PagingGoodsFavoriteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_query_service_45310e7e22fba0ea, []int{3}
}
...
type SPagingGoodsFavorite struct {
	...
	OnShelves            bool     `protobuf:"varint,5,opt,name=on_shelves,json=onShelves,proto3" json:"on_shelves"`
	StockNum             int32    `protobuf:"varint,6,opt,name=stock_num,json=stockNum,proto3" json:"stock_num"`
	SalePrice            string   `protobuf:"bytes,7,opt,name=sale_price,json=salePrice,proto3" json:"sale_price"`
...
func (*SPagingGoodsFavorite) Descriptor() ([]byte, []int) {
	return fileDescriptor_query_service_45310e7e22fba0ea, []int{4}
}
...
type QueryPagingShopRequest struct {
	...
	// 是否只查询营业中的店铺
	OnlyBusiness         bool     `protobuf:"varint,2,opt,name=only_business,json=onlyBusiness,proto3" json:"only_business"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*QueryPagingShopRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_query_service_45310e7e22fba0ea, []int{5}
}
...
func (*QueryPagingShopsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_query_service_45310e7e22fba0ea, []int{6}
}
...
type QueryPagingShop struct {
	...
	CreateTime           int64    `protobuf:"zigzag64,6,opt,name=create_time,json=createTime,proto3" json:"create_time"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*QueryPagingShop) Descriptor() ([]byte, []int) {
	return fileDescriptor_query_service_45310e7e22fba0ea, []int{7}
}
...
func (*MemberOrderPagingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_query_service_45310e7e22fba0ea, []int{8}
}
...
func (*MemberOrderPagingResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_query_service_45310e7e22fba0ea, []int{9}
}
...
type PagedMemberSubOrder struct {
	...
	ParentNo             string        `protobuf:"bytes,3,opt,name=parent_no,json=parentNo,proto3" json:"parent_no"`
	...
	ItemAmount           float64       `protobuf:"fixed64,7,opt,name=item_amount,json=itemAmount,proto3" json:"item_amount"`
	DiscountAmount       float64       `protobuf:"fixed64,8,opt,name=discount_amount,json=discountAmount,proto3" json:"discount_amount"`
	ExpressFee           float64       `protobuf:"fixed64,9,opt,name=express_fee,json=expressFee,proto3" json:"express_fee"`
	PackageFee           float64       `protobuf:"fixed64,10,opt,name=package_fee,json=packageFee,proto3" json:"package_fee"`
	IsPaid               bool          `protobuf:"varint,11,opt,name=is_paid,json=isPaid,proto3" json:"is_paid"`
	...
	StateText            string        `protobuf:"bytes,14,opt,name=state_text,json=stateText,proto3" json:"state_text"`
	CreateTime           int64         `protobuf:"zigzag64,15,opt,name=create_time,json=createTime,proto3" json:"create_time"`
...
func (*PagedMemberSubOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_query_service_45310e7e22fba0ea, []int{10}
}
...
type MemberListRequest struct {
	IdList               []int64  `protobuf:"varint,1,rep,packed,name=id_list,json=idList,proto3" json:"id_list"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*MemberListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_query_service_45310e7e22fba0ea, []int{11}
}
...
func (*MemberSearchRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_query_service_45310e7e22fba0ea, []int{12}
}
...
func (*MemberListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_query_service_45310e7e22fba0ea, []int{13}
}
...
func (*MemberListSingle) Descriptor() ([]byte, []int) {
	return fileDescriptor_query_service_45310e7e22fba0ea, []int{14}
}
...
func init() { proto.RegisterFile("query_service.proto", fileDescriptor_query_service_45310e7e22fba0ea) }

var fileDescriptor_query_service_45310e7e22fba0ea = []byte{
	...
	,
}
