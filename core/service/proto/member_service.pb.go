...
func (FavoriteType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_member_service_1549b78a70cbc941, []int{0}
}
...
func (*DepthRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_member_service_1549b78a70cbc941, []int{1}
}
...
func (*InviterIdListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_member_service_1549b78a70cbc941, []int{2}
}
...
func (*InviteQuantityRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_member_service_1549b78a70cbc941, []int{3}
}
...
func (*MemberIdListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_member_service_1549b78a70cbc941, []int{4}
}
...
func init() {
	proto.RegisterFile("member_service.proto", fileDescriptor_member_service_1549b78a70cbc941)
}

var fileDescriptor_member_service_1549b78a70cbc941 = []byte{
	// 1371 bytes of a gzipped FileDescriptorProto
	,
}
