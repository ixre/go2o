...
func (*SCoverageValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_shipment_ac706cfa8f74c062, []int{0}
}
...
func (*ShipmentOrderListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_shipment_ac706cfa8f74c062, []int{1}
}
...
func (*SShipmentOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_shipment_ac706cfa8f74c062, []int{2}
}
...
func (*SShipmentItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_shipment_ac706cfa8f74c062, []int{3}
}
...
func (*LogisticFlowTrackRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_shipment_ac706cfa8f74c062, []int{4}
}
...
func (*OrderLogisticTrackRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_shipment_ac706cfa8f74c062, []int{5}
}
...
func (*SShipOrderTrack) Descriptor() ([]byte, []int) {
	return fileDescriptor_shipment_ac706cfa8f74c062, []int{6}
}
...
func (*SShipFlow) Descriptor() ([]byte, []int) {
	return fileDescriptor_shipment_ac706cfa8f74c062, []int{7}
}
...
func init() { proto.RegisterFile("message/shipment.proto", fileDescriptor_shipment_ac706cfa8f74c062) }

var fileDescriptor_shipment_ac706cfa8f74c062 = []byte{
