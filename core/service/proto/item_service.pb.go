...
func (*ItemDetailRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_item_service_f9e0977eb99ade84, []int{0}
}
...
func (*PagingGoodsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_item_service_f9e0977eb99ade84, []int{1}
}
...
func (*PagingShopGoodsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_item_service_f9e0977eb99ade84, []int{2}
}
...
func (*SaleLabelItemsRequest_) Descriptor() ([]byte, []int) {
	return fileDescriptor_item_service_f9e0977eb99ade84, []int{3}
}
...
func init() { proto.RegisterFile("item_service.proto", fileDescriptor_item_service_f9e0977eb99ade84) }

var fileDescriptor_item_service_f9e0977eb99ade84 = []byte{
	...
	,
}
