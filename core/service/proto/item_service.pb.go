...
func (EItemSalesType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_item_service_d7b807bcc480f002, []int{0}
}
...
func (*ItemDetailRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_item_service_d7b807bcc480f002, []int{1}
}
...
func (*PagingGoodsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_item_service_d7b807bcc480f002, []int{2}
}
...
func (*PagingShopGoodsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_item_service_d7b807bcc480f002, []int{3}
}
...
func init() { proto.RegisterFile("item_service.proto", fileDescriptor_item_service_d7b807bcc480f002) }

var fileDescriptor_item_service_d7b807bcc480f002 = []byte{
	// 662 bytes of a gzipped FileDescriptorProto
	,
}
