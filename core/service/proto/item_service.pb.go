...
func (*ItemDetailRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_item_service_8147a780944d45d5, []int{0}
}
...
func (*PagingGoodsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_item_service_8147a780944d45d5, []int{1}
}
...
func (*PagingShopGoodsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_item_service_8147a780944d45d5, []int{2}
}
...
func (*SaleLabelItemsRequest_) Descriptor() ([]byte, []int) {
	return fileDescriptor_item_service_8147a780944d45d5, []int{3}
}
...
func init() { proto.RegisterFile("item_service.proto", fileDescriptor_item_service_8147a780944d45d5) }

var fileDescriptor_item_service_8147a780944d45d5 = []byte{
	// 842 bytes of a gzipped FileDescriptorProto
	,
}
