...
func (*ItemDetailRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_item_service_b5c8152a184ab317, []int{0}
}
...
func (*PagingGoodsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_item_service_b5c8152a184ab317, []int{1}
}
...
func (*PagingShopGoodsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_item_service_b5c8152a184ab317, []int{2}
}
...
func (*SaleLabelItemsRequest_) Descriptor() ([]byte, []int) {
	return fileDescriptor_item_service_b5c8152a184ab317, []int{3}
}
...
func init() { proto.RegisterFile("item_service.proto", fileDescriptor_item_service_b5c8152a184ab317) }

var fileDescriptor_item_service_b5c8152a184ab317 = []byte{
	// 801 bytes of a gzipped FileDescriptorProto
	,
}
