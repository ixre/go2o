...
func (EAfterSalesType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_aftersales_service_5d78079c449d3638, []int{0}
}
...
type SubmitAfterSalesOrderRequest struct {
	OrderId              int64           `protobuf:"varint,1,opt,name=order_id,json=orderId,proto3" json:"order_id"`
	AfterSalesType       EAfterSalesType `protobuf:"varint,2,opt,name=after_sales_type,json=afterSalesType,proto3,enum=EAfterSalesType" json:"after_sales_type"`
	ItemSnapshotId       int64           `protobuf:"varint,3,opt,name=item_snapshot_id,json=itemSnapshotId,proto3" json:"item_snapshot_id"`
...
func (*SubmitAfterSalesOrderRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_aftersales_service_5d78079c449d3638, []int{1}
}
...
type SubmitAfterSalesOrderResponse struct {
	...
	AfterSalesOrderId    int64    `protobuf:"varint,3,opt,name=after_sales_order_id,json=afterSalesOrderId,proto3" json:"after_sales_order_id"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*SubmitAfterSalesOrderResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_aftersales_service_5d78079c449d3638, []int{2}
}
...
func (*AfterSalesOrderListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_aftersales_service_5d78079c449d3638, []int{3}
}
...
func (*PagingBuyerOrdersRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_aftersales_service_5d78079c449d3638, []int{4}
}
...
func (*PagingSellerOrdersRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_aftersales_service_5d78079c449d3638, []int{5}
}
...
func (*PagingBuyerAfterSalesOrderListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_aftersales_service_5d78079c449d3638, []int{6}
}
...
func (*PagingSellerAfterSalesOrderListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_aftersales_service_5d78079c449d3638, []int{7}
}
...
type SAfterSalesOrder struct {
	...
	// 订单编号
	RelateOrderId int64 `protobuf:"varint,2,opt,name=relate_order_id,json=relateOrderId,proto3" json:"relate_order_id"`
	// 运营商编号
	...
	// 类型，退货、换货、维修
	AfterSalesType int32 `protobuf:"varint,5,opt,name=after_sales_type,json=afterSalesType,proto3" json:"after_sales_type"`
	// 退货的商品项编号
	...
	// 联系人
	PersonName string `protobuf:"bytes,10,opt,name=person_name,json=personName,proto3" json:"person_name"`
	// 联系电话
	PersonPhone string `protobuf:"bytes,11,opt,name=person_phone,json=personPhone,proto3" json:"person_phone"`
	// 退货的快递服务商编号
	ReturnSpName string `protobuf:"bytes,12,opt,name=return_sp_name,json=returnSpName,proto3" json:"return_sp_name"`
	// 退货的快递单号
	ReturnSpOrder string `protobuf:"bytes,13,opt,name=return_sp_order,json=returnSpOrder,proto3" json:"return_sp_order"`
	// 退货凭证
	ReturnSpImage string `protobuf:"bytes,14,opt,name=return_sp_image,json=returnSpImage,proto3" json:"return_sp_image"`
	// 备注(系统)
	Remark string `protobuf:"bytes,15,opt,name=remark,proto3" json:"remark"`
	// 运营商备注
	VendorRemark string `protobuf:"bytes,16,opt,name=vendor_remark,json=vendorRemark,proto3" json:"vendor_remark"`
	// 售后单状态
	...
	// 订单状态
	StateText            string   `protobuf:"bytes,20,opt,name=state_text,json=stateText,proto3" json:"state_text"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*SAfterSalesOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_aftersales_service_5d78079c449d3638, []int{8}
}
...
type SPagingBuyerAfterSalesOrder struct {
	...
	VendorId int64 `protobuf:"varint,3,opt,name=vendor_id,json=vendorId,proto3" json:"vendor_id"`
	// 运营商名称
	SellerName string `protobuf:"bytes,4,opt,name=seller_name,json=sellerName,proto3" json:"seller_name"`
	// 类型，退货、换货、维修
	AfterSalesType int32 `protobuf:"varint,5,opt,name=after_sales_type,json=afterSalesType,proto3" json:"after_sales_type"`
	// 退货的商品项编号
	SnapshotId int64 `protobuf:"varint,6,opt,name=snapshot_id,json=snapshotId,proto3" json:"snapshot_id"`
	...
	ItemTitle string `protobuf:"bytes,9,opt,name=item_title,json=itemTitle,proto3" json:"item_title"`
	ItemImage string `protobuf:"bytes,10,opt,name=item_image,json=itemImage,proto3" json:"item_image"`
	// 售后单状态
...
func (*SPagingBuyerAfterSalesOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_aftersales_service_5d78079c449d3638, []int{9}
}
...
type SPagingSellerAfterSalesOrder struct {
	...
	// 会员名称
	BuyerName string `protobuf:"bytes,4,opt,name=buyer_name,json=buyerName,proto3" json:"buyer_name"`
	// 类型，退货、换货、维修
	AfterSalesType int32 `protobuf:"varint,5,opt,name=after_sales_type,json=afterSalesType,proto3" json:"after_sales_type"`
	// 退货的商品项编号
	SnapshotId int64 `protobuf:"varint,6,opt,name=snapshot_id,json=snapshotId,proto3" json:"snapshot_id"`
...
func (*SPagingSellerAfterSalesOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_aftersales_service_5d78079c449d3638, []int{10}
}
...
type ExchangeShipmentRequest struct {
	...
	SpOrder              string   `protobuf:"bytes,3,opt,name=sp_order,json=spOrder,proto3" json:"sp_order"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*ExchangeShipmentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_aftersales_service_5d78079c449d3638, []int{11}
}
...
func init() {
	proto.RegisterFile("aftersales_service.proto", fileDescriptor_aftersales_service_5d78079c449d3638)
}

var fileDescriptor_aftersales_service_5d78079c449d3638 = []byte{
	...
	,
}
