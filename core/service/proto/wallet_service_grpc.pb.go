...
type WalletServiceClient interface {
	...
	// * 完成提现
	FinishWithdrawal(ctx context.Context, in *FinishWithdrawRequest, opts ...grpc.CallOption) (*Result, error)
	// * 获取分页钱包日志
...
func (c *walletServiceClient) FinishWithdrawal(ctx context.Context, in *FinishWithdrawRequest, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, WalletService_FinishWithdrawal_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WalletServiceServer interface {
	...
	// * 完成提现
	FinishWithdrawal(context.Context, *FinishWithdrawRequest) (*Result, error)
	// * 获取分页钱包日志
...
func (UnimplementedWalletServiceServer) FinishWithdrawal(context.Context, *FinishWithdrawRequest) (*Result, error) {
...
func _WalletService_FinishWithdrawal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WalletService_FinishWithdrawal_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServiceServer).FinishWithdrawal(ctx, req.(*FinishWithdrawRequest))
	}
	return interceptor(ctx, in, info, handler)
}
