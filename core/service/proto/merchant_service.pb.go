...
func (*MerchantOrderRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_merchant_service_5560e5158c17db9a, []int{0}
}
...
func (*PagingMerchantOrderListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_merchant_service_5560e5158c17db9a, []int{1}
}
...
func (*SMerchantOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_merchant_service_5560e5158c17db9a, []int{2}
}
...
func init() {
	proto.RegisterFile("merchant_service.proto", fileDescriptor_merchant_service_5560e5158c17db9a)
}

var fileDescriptor_merchant_service_5560e5158c17db9a = []byte{
	// 1178 bytes of a gzipped FileDescriptorProto
	,
}
