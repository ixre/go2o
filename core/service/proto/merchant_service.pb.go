...
func (*MerchantOrderRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_merchant_service_ac2be1588daf100a, []int{0}
}
...
func (*PagingMerchantOrderListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_merchant_service_ac2be1588daf100a, []int{1}
}
...
func (*SMerchantOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_merchant_service_ac2be1588daf100a, []int{2}
}
...
func init() {
	proto.RegisterFile("merchant_service.proto", fileDescriptor_merchant_service_ac2be1588daf100a)
}

var fileDescriptor_merchant_service_ac2be1588daf100a = []byte{
	...
	,
}
