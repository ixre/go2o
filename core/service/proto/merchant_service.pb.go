...
func (*MerchantOrderRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_merchant_service_e754fc9fbc27fa45, []int{0}
}
...
func (*PagingMerchantOrderListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_merchant_service_e754fc9fbc27fa45, []int{1}
}
...
type SMerchantOrder struct {
	...
	BuyerName string `protobuf:"bytes,5,opt,name=buyer_name,json=buyerName,proto3" json:"buyer_name"`
	// 订单详情,主要描述订单的内容
	...
	CreateTime           int64             `protobuf:"varint,15,opt,name=create_time,json=createTime,proto3" json:"create_time"`
...
func (*SMerchantOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_merchant_service_e754fc9fbc27fa45, []int{2}
}
...
func init() {
	proto.RegisterFile("merchant_service.proto", fileDescriptor_merchant_service_e754fc9fbc27fa45)
}

var fileDescriptor_merchant_service_e754fc9fbc27fa45 = []byte{
	// 1272 bytes of a gzipped FileDescriptorProto
	,
}
