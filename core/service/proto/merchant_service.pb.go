...
func (*MerchantOrderRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_merchant_service_7c0b58303b677b3e, []int{0}
}
...
func (*PagingMerchantOrderListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_merchant_service_7c0b58303b677b3e, []int{1}
}
...
func (*SMerchantOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_merchant_service_7c0b58303b677b3e, []int{2}
}
...
func init() {
	proto.RegisterFile("merchant_service.proto", fileDescriptor_merchant_service_7c0b58303b677b3e)
}

var fileDescriptor_merchant_service_7c0b58303b677b3e = []byte{
	...
	,
}
