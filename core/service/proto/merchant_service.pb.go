...
func (*MerchantOrderRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_merchant_service_fc53451bfba7ee31, []int{0}
}
...
func (*PagingMerchantOrderListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_merchant_service_fc53451bfba7ee31, []int{1}
}
...
func (*SMerchantOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_merchant_service_fc53451bfba7ee31, []int{2}
}
...
func init() {
	proto.RegisterFile("merchant_service.proto", fileDescriptor_merchant_service_fc53451bfba7ee31)
}

var fileDescriptor_merchant_service_fc53451bfba7ee31 = []byte{
