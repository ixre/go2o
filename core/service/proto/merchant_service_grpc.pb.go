...
func (c *merchantServiceClient) CompleteTransaction(ctx context.Context, in *FinishUserTransactionRequest, opts ...grpc.CallOption) (*TxResult, error) {
	out := new(TxResult)
	err := c.cc.Invoke(ctx, MerchantService_CompleteTransaction_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *merchantServiceClient) GenerateDailyBill(ctx context.Context, in *GenerateMerchantBillRequest, opts ...grpc.CallOption) (*TxResult, error) {
	out := new(TxResult)
	err := c.cc.Invoke(ctx, MerchantService_GenerateDailyBill_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *merchantServiceClient) GenerateMonthlyBill(ctx context.Context, in *GenerateMerchantMonthlyBillRequest, opts ...grpc.CallOption) (*TxResult, error) {
	out := new(TxResult)
	err := c.cc.Invoke(ctx, MerchantService_GenerateMonthlyBill_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
