...
func (c *advertisementServiceClient) SaveSwiperAdImage(ctx context.Context, in *SaveSwiperImageRequest, opts ...grpc.CallOption) (*Result, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Result)
	err := c.cc.Invoke(ctx, AdvertisementService_SaveSwiperAdImage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *advertisementServiceClient) GetSwiperAdImage(ctx context.Context, in *ImageIdRequest, opts ...grpc.CallOption) (*SImageAdData, error) {
	...
	err := c.cc.Invoke(ctx, AdvertisementService_GetSwiperAdImage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *advertisementServiceClient) DeleteSwiperAdImage(ctx context.Context, in *ImageIdRequest, opts ...grpc.CallOption) (*Result, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Result)
	err := c.cc.Invoke(ctx, AdvertisementService_DeleteSwiperAdImage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
