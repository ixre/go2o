...
func (EState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_test_74b811864be113cd, []int{0}
}
...
func (*UserResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_74b811864be113cd, []int{1}
}
...
func init() { proto.RegisterFile("test.proto", fileDescriptor_test_74b811864be113cd) }

var fileDescriptor_test_74b811864be113cd = []byte{
