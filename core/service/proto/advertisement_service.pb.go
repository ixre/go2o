...
func init() {
	proto.RegisterFile("advertisement_service.proto", fileDescriptor_advertisement_service_f973b37a6515626f)
}

var fileDescriptor_advertisement_service_f973b37a6515626f = []byte{
