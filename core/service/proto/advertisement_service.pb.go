...
func init() {
	proto.RegisterFile("advertisement_service.proto", fileDescriptor_advertisement_service_8bd69aa42b9be411)
}

var fileDescriptor_advertisement_service_8bd69aa42b9be411 = []byte{
