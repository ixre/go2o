...
type SWorkorder struct {
	...
	// 类型, 1: 建议 2:申诉
	ClassId int32 `protobuf:"varint,3,opt,name=classId,proto3" json:"classId"`
	// 关联商户
	...
	// 关联业务, 如:CHARGE:2014050060
	Wip string `protobuf:"bytes,6,opt,name=wip,proto3" json:"wip"`
	// Subject
	...
	// 是否开放评论
	IsOpened int32 `protobuf:"varint,9,opt,name=isOpened,proto3" json:"isOpened"`
	// 诉求描述
	HopeDesc string `protobuf:"bytes,10,opt,name=hopeDesc,proto3" json:"hopeDesc"`
	// 图片
	FirstPhoto string `protobuf:"bytes,11,opt,name=firstPhoto,proto3" json:"firstPhoto"`
	// m
	PhotoList string `protobuf:"bytes,12,opt,name=photoList,proto3" json:"photoList"`
	// 状态,1:待处理 2:处理中 3:已完结
	Status int32 `protobuf:"varint,13,opt,name=status,proto3" json:"status"`
	// 分配的客服编号
	AllocateAid int64 `protobuf:"varint,14,opt,name=allocateAid,proto3" json:"allocateAid"`
	// 服务评分
	ServiceRank int32 `protobuf:"varint,15,opt,name=serviceRank,proto3" json:"serviceRank"`
	// 服务评价
	ServiceApprise string `protobuf:"bytes,16,opt,name=serviceApprise,proto3" json:"serviceApprise"`
	// 是否有用 0:未评价 1:是 2:否
	IsUsefully int32 `protobuf:"varint,17,opt,name=isUsefully,proto3" json:"isUsefully"`
	// 创建时间
...
var file_workorder_service_proto_rawDesc = []byte{
	...
	0x72, 0x49, 0x64, 0x22, 0x9c, 0x04, 0x0a, 0x0a, 0x53, 0x57, 0x6f, 0x72, 0x6b, 0x6f, 0x72, 0x64,
	...
	,
	...
	,
