...
type RCartItem struct {
	...
	// 是否只勾选当前商品(直接购买)
	CheckOnly bool `protobuf:"varint,4,opt,name=checkOnly,proto3" json:"checkOnly"`
}
...
var file_cart_service_proto_rawDesc = []byte{
	...
	0x6c, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x4f,
