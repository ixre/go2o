...
func (*SettlePersistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cart_service_98108335d968774f, []int{0}
}
...
func (*CartItemRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cart_service_98108335d968774f, []int{1}
}
...
func (*CheckSignRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cart_service_98108335d968774f, []int{2}
}
...
func (*CartCode) Descriptor() ([]byte, []int) {
	return fileDescriptor_cart_service_98108335d968774f, []int{3}
}
...
func (*SettleMeta_) Descriptor() ([]byte, []int) {
	return fileDescriptor_cart_service_98108335d968774f, []int{4}
}
...
func (*SettleShopMeta_) Descriptor() ([]byte, []int) {
	return fileDescriptor_cart_service_98108335d968774f, []int{5}
}
...
func (*SettleDeliverMeta_) Descriptor() ([]byte, []int) {
	return fileDescriptor_cart_service_98108335d968774f, []int{6}
}
...
func init() { proto.RegisterFile("cart_service.proto", fileDescriptor_cart_service_98108335d968774f) }

var fileDescriptor_cart_service_98108335d968774f = []byte{
