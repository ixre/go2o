...
type SOrderItem struct {
	...
	// 商品规格
	ItemSpec string `protobuf:"bytes,9,opt,name=itemSpec,proto3" json:"itemSpec"`
	// 商品数量
...
func (x *SOrderItem) GetItemSpec() string {
	if x != nil {
		return x.ItemSpec
	}
	return ""
...
var file_message_order_dto_proto_rawDesc = []byte{
	...
	0x12, 0x1a, 0x0a, 0x08, 0x69, 0x74, 0x65, 0x6d, 0x53, 0x70, 0x65, 0x63, 0x18, 0x09, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x08, 0x69, 0x74, 0x65, 0x6d, 0x53, 0x70, 0x65, 0x63, 0x12, 0x1a, 0x0a, 0x08,
