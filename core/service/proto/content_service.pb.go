...
func (*PagingArticleRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_content_service_dffb4462a2e51045, []int{0}
}
...
func (*ArticleListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_content_service_dffb4462a2e51045, []int{1}
}
...
func (*SArticleCategory) Descriptor() ([]byte, []int) {
	return fileDescriptor_content_service_dffb4462a2e51045, []int{2}
}
...
func (*SArticle) Descriptor() ([]byte, []int) {
	return fileDescriptor_content_service_dffb4462a2e51045, []int{3}
}
...
func (*SPage) Descriptor() ([]byte, []int) {
	return fileDescriptor_content_service_dffb4462a2e51045, []int{4}
}
...
func (*ArticleCategoriesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_content_service_dffb4462a2e51045, []int{5}
}
...
func init() {
	proto.RegisterFile("content_service.proto", fileDescriptor_content_service_dffb4462a2e51045)
}

var fileDescriptor_content_service_dffb4462a2e51045 = []byte{
	...
	,
}
