...
type BankCardNo struct {
	CardNo               string   `protobuf:"bytes,1,opt,name=Card_no,json=CardNo,proto3" json:"Card_no"`
...
func (*BankCardNo) Descriptor() ([]byte, []int) {
	return fileDescriptor_quick_pay_service_3edcaa20976a20d8, []int{0}
}
...
type CardBinQueryResponse struct {
	// 错误信息
	ErrMsg string `protobuf:"bytes,1,opt,name=err_msg,json=errMsg,proto3" json:"err_msg"`
	// 银行名称
	BankName string `protobuf:"bytes,2,opt,name=bank_name,json=bankName,proto3" json:"bank_name"`
	// 用户银行卡号
	BankCardNo string `protobuf:"bytes,3,opt,name=bank_card_no,json=bankCardNo,proto3" json:"bank_card_no"`
	// 返回的银行代号
	BankCode string `protobuf:"bytes,4,opt,name=bank_code,json=bankCode,proto3" json:"bank_code"`
	// 银行卡类型（0=储蓄卡,1=信用卡）
	CardType int32 `protobuf:"varint,5,opt,name=card_type,json=cardType,proto3" json:"card_type"`
	// 是否需要银行端授权,如果否,则直接使用短信既可授权
	RequireBankSideAuth  bool     `protobuf:"varint,6,opt,name=require_bank_side_auth,json=requireBankSideAuth,proto3" json:"require_bank_side_auth"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*CardBinQueryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_quick_pay_service_3edcaa20976a20d8, []int{1}
}
...
type BankAuthRequest struct {
	...
	// 姓名,如：张三
	BankAccountName string `protobuf:"bytes,3,opt,name=bank_account_name,json=bankAccountName,proto3" json:"bank_account_name"`
	// 用户银行绑定的手机号
	Mobile string `protobuf:"bytes,4,opt,name=mobile,proto3" json:"mobile"`
	// 用户身份证号码,如：100100052000000000
	IdCardNo             string   `protobuf:"bytes,5,opt,name=id_card_no,json=idCardNo,proto3" json:"id_card_no"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*BankAuthRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_quick_pay_service_3edcaa20976a20d8, []int{2}
}
...
type BankAuthResponse struct {
	...
	// 认证的Form表单
	AuthForm string `protobuf:"bytes,3,opt,name=auth_form,json=authForm,proto3" json:"auth_form"`
	// 认证需要的其他数据
	AuthData             map[string]string `protobuf:"bytes,4,rep,name=auth_data,json=authData,proto3" json:"auth_data" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (*BankAuthResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_quick_pay_service_3edcaa20976a20d8, []int{3}
}
...
func (*BankAuthQueryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_quick_pay_service_3edcaa20976a20d8, []int{4}
}
...
type BankAuthQueryResponse struct {
	...
	BankAuthToken        string   `protobuf:"bytes,3,opt,name=bank_auth_token,json=bankAuthToken,proto3" json:"bank_auth_token"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*BankAuthQueryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_quick_pay_service_3edcaa20976a20d8, []int{5}
}
...
type QPaymentRequest struct {
	...
	// 支付金额,实际金额*100,无小数
	TradeFee int32 `protobuf:"varint,2,opt,name=trade_fee,json=tradeFee,proto3" json:"trade_fee"`
	// 支付商品名称
	Subject string `protobuf:"bytes,3,opt,name=subject,proto3" json:"subject"`
	// 银行授权码
	BankAuthToken string `protobuf:"bytes,4,opt,name=bank_auth_token,json=bankAuthToken,proto3" json:"bank_auth_token"`
	// 交易用户IP
	TradeUserIp string `protobuf:"bytes,5,opt,name=trade_user_ip,json=tradeUserIp,proto3" json:"trade_user_ip"`
	// 异步通知地址,非必填
	NotifyUrl string `protobuf:"bytes,6,opt,name=notify_url,json=notifyUrl,proto3" json:"notify_url"`
	// 同步返回地址,非必填
	ReturnUrl string `protobuf:"bytes,7,opt,name=return_url,json=returnUrl,proto3" json:"return_url"`
	// 自定义数据
	Nonce string `protobuf:"bytes,8,opt,name=nonce,proto3" json:"nonce"`
	// 安全码+随机内容md5后的字符串
	SafeSign             string   `protobuf:"bytes,9,opt,name=safe_sign,json=safeSign,proto3" json:"safe_sign"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*QPaymentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_quick_pay_service_3edcaa20976a20d8, []int{6}
}
...
type QPaymentResponse struct {
	...
	// 第三方支单据号
	BillNo               string   `protobuf:"bytes,3,opt,name=bill_no,json=billNo,proto3" json:"bill_no"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*QPaymentResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_quick_pay_service_3edcaa20976a20d8, []int{7}
}
...
func (*QPaymentQueryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_quick_pay_service_3edcaa20976a20d8, []int{8}
}
...
func (*QPaymentQueryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_quick_pay_service_3edcaa20976a20d8, []int{9}
}
...
type CheckQPaySignRequest struct {
	// 签名类型
	SignType string `protobuf:"bytes,1,opt,name=sign_type,json=signType,proto3" json:"sign_type"`
	// 签名
...
func (*CheckQPaySignRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_quick_pay_service_3edcaa20976a20d8, []int{10}
}
...
type CheckQPaySignResponse struct {
	SignOk               bool     `protobuf:"varint,1,opt,name=sign_ok,json=signOk,proto3" json:"sign_ok"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*CheckQPaySignResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_quick_pay_service_3edcaa20976a20d8, []int{11}
}
...
type CardTransferRequest struct {
	...
	OrderNo string `protobuf:"bytes,1,opt,name=order_no,json=orderNo,proto3" json:"order_no"`
	// 银行编号
	BankCode string `protobuf:"bytes,2,opt,name=bank_code,json=bankCode,proto3" json:"bank_code"`
	// 是否为对私转账
	PersonTransfer bool `protobuf:"varint,3,opt,name=person_transfer,json=personTransfer,proto3" json:"person_transfer"`
	// 付款金额,实际金额*100,无小数
	TradeFee int32 `protobuf:"varint,4,opt,name=trade_fee,json=tradeFee,proto3" json:"trade_fee"`
	// 银行账户
	BankCardNo string `protobuf:"bytes,5,opt,name=bank_card_no,json=bankCardNo,proto3" json:"bank_card_no"`
	// 收款人姓名,如：张三
	BankAccountName string `protobuf:"bytes,6,opt,name=bank_account_name,json=bankAccountName,proto3" json:"bank_account_name"`
	// 付款事由
	...
	// 支行信息
	StoreName            string   `protobuf:"bytes,10,opt,name=store_name,json=storeName,proto3" json:"store_name"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*CardTransferRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_quick_pay_service_3edcaa20976a20d8, []int{12}
}
...
type BatchTransferRequest struct {
	...
	BatchTradeNo string `protobuf:"bytes,1,opt,name=batch_trade_no,json=batchTradeNo,proto3" json:"batch_trade_no"`
	// 付款总金额,实际金额*100,无小数
	BatchTradeFee int32 `protobuf:"varint,2,opt,name=batch_trade_fee,json=batchTradeFee,proto3" json:"batch_trade_fee"`
	// 交易用户IP
	TradeUserIp string `protobuf:"bytes,3,opt,name=trade_user_ip,json=tradeUserIp,proto3" json:"trade_user_ip"`
	// 批量付款记录
	BatchList []*CardTransferRequest `protobuf:"bytes,4,rep,name=batch_list,json=batchList,proto3" json:"batch_list"`
	// 异步通知地址,非必填
	NotifyUrl string `protobuf:"bytes,5,opt,name=notify_url,json=notifyUrl,proto3" json:"notify_url"`
	// 自定义数据
	Nonce string `protobuf:"bytes,6,opt,name=nonce,proto3" json:"nonce"`
	// 安全码+随机内容md5后的字符串
	SafeSign             string   `protobuf:"bytes,7,opt,name=safe_sign,json=safeSign,proto3" json:"safe_sign"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*BatchTransferRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_quick_pay_service_3edcaa20976a20d8, []int{13}
}
...
func (*BatchTransferResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_quick_pay_service_3edcaa20976a20d8, []int{14}
}
...
func init() {
	proto.RegisterFile("quick_pay_service.proto", fileDescriptor_quick_pay_service_3edcaa20976a20d8)
}

var fileDescriptor_quick_pay_service_3edcaa20976a20d8 = []byte{
	...
	,
}
