...
func (*SCoverageValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_shipment_dto_62ca015a948d76b3, []int{0}
}
...
func (*ShipmentOrderListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_shipment_dto_62ca015a948d76b3, []int{1}
}
...
type SShipmentOrder struct {
	...
	// 子订单编号
	SubOrderId int64 `protobuf:"varint,3,opt,name=sub_order_id,json=subOrderId,proto3" json:"sub_order_id"`
	// 快递SP编号
	ExpressSpId int64 `protobuf:"varint,4,opt,name=express_sp_id,json=expressSpId,proto3" json:"express_sp_id"`
	// 快递SP单号
	ShipOrderNo string `protobuf:"bytes,5,opt,name=ship_order_no,json=shipOrderNo,proto3" json:"ship_order_no"`
	// 物流日志
	ShipmentLog string `protobuf:"bytes,6,opt,name=shipment_log,json=shipmentLog,proto3" json:"shipment_log"`
	// 运费
	Amount float64 `protobuf:"fixed64,7,opt,name=amount,proto3" json:"amount"`
	// 实际运费
	FinalAmount float64 `protobuf:"fixed64,8,opt,name=final_amount,json=finalAmount,proto3" json:"final_amount"`
	// 发货时间
	ShipTime int64 `protobuf:"varint,9,opt,name=ship_time,json=shipTime,proto3" json:"ship_time"`
	// 状态
...
func (*SShipmentOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_shipment_dto_62ca015a948d76b3, []int{2}
}
...
type SShipmentItem struct {
	...
	// 实际运费
	FinalAmount          float64  `protobuf:"fixed64,5,opt,name=final_amount,json=finalAmount,proto3" json:"final_amount"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*SShipmentItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_shipment_dto_62ca015a948d76b3, []int{3}
}
...
type LogisticFlowTrackRequest struct {
	ShipperCode          string   `protobuf:"bytes,1,opt,name=shipper_code,json=shipperCode,proto3" json:"shipper_code"`
	LogisticCode         string   `protobuf:"bytes,2,opt,name=logistic_code,json=logisticCode,proto3" json:"logistic_code"`
...
func (*LogisticFlowTrackRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_shipment_dto_62ca015a948d76b3, []int{4}
}
...
type OrderLogisticTrackRequest struct {
	ShipOrderId          int64    `protobuf:"zigzag64,1,opt,name=ship_order_id,json=shipOrderId,proto3" json:"ship_order_id"`
...
func (*OrderLogisticTrackRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_shipment_dto_62ca015a948d76b3, []int{5}
}
...
type SShipOrderTrack struct {
	...
	// 物流单号
	LogisticCode string `protobuf:"bytes,3,opt,name=logistic_code,json=logisticCode,proto3" json:"logistic_code"`
	// 承运商代码
	ShipperCode string `protobuf:"bytes,4,opt,name=shipper_code,json=shipperCode,proto3" json:"shipper_code"`
	// * 承运商名称
	ShipperName string `protobuf:"bytes,5,opt,name=shipper_name,json=shipperName,proto3" json:"shipper_name"`
	// 发货状态
	ShipState string `protobuf:"bytes,6,opt,name=ship_state,json=shipState,proto3" json:"ship_state"`
	// 更新时间
	UpdateTime int64 `protobuf:"zigzag64,7,opt,name=update_time,json=updateTime,proto3" json:"update_time"`
	// 包含发货单流
...
func (*SShipOrderTrack) Descriptor() ([]byte, []int) {
	return fileDescriptor_shipment_dto_62ca015a948d76b3, []int{6}
}
...
func (*SShipFlow) Descriptor() ([]byte, []int) {
	return fileDescriptor_shipment_dto_62ca015a948d76b3, []int{7}
}
...
func init() {
	proto.RegisterFile("message/shipment_dto.proto", fileDescriptor_shipment_dto_62ca015a948d76b3)
}

var fileDescriptor_shipment_dto_62ca015a948d76b3 = []byte{
	// 696 bytes of a gzipped FileDescriptorProto
	,
}
