...
func (EPayMethod) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_payment_service_4b8bee54f88850ed, []int{0}
}

type AdjustOrderRequest struct {
	PaymentNo            string   `protobuf:"bytes,1,opt,name=payment_no,json=paymentNo,proto3" json:"payment_no"`
...
type DiscountBalanceRequest struct {
	OrderId              int32    `protobuf:"zigzag32,1,opt,name=order_id,json=orderId,proto3" json:"order_id"`
...
func (*DiscountBalanceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_payment_service_4b8bee54f88850ed, []int{1}
}
...
type DiscountIntegralRequest struct {
	...
	IgnoreOut            bool     `protobuf:"varint,3,opt,name=ignore_out,json=ignoreOut,proto3" json:"ignore_out"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*DiscountIntegralRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_payment_service_4b8bee54f88850ed, []int{2}
}
...
type WalletPaymentRequest struct {
	...
	MergePay             bool     `protobuf:"varint,2,opt,name=merge_pay,json=mergePay,proto3" json:"merge_pay"`
...
func (*WalletPaymentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_payment_service_4b8bee54f88850ed, []int{3}
}
...
func (*HyperPaymentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_payment_service_4b8bee54f88850ed, []int{4}
}
...
type FinishPaymentRequest struct {
	TradeNo              string   `protobuf:"bytes,1,opt,name=trade_no,json=tradeNo,proto3" json:"trade_no"`
	SpName               string   `protobuf:"bytes,2,opt,name=sp_name,json=spName,proto3" json:"sp_name"`
...
func (*FinishPaymentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_payment_service_4b8bee54f88850ed, []int{5}
}
...
func (*OrderInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_payment_service_4b8bee54f88850ed, []int{6}
}
...
func (*MixedPaymentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_payment_service_4b8bee54f88850ed, []int{7}
}
...
type PayGatewayRequest struct {
	...
	UserId               int64             `protobuf:"zigzag64,2,opt,name=user_id,json=userId,proto3" json:"user_id"`
...
func (*PayGatewayRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_payment_service_4b8bee54f88850ed, []int{8}
}
...
type SPaymentOrder struct {
	...
	TradeNo string `protobuf:"bytes,1,opt,name=trade_no,json=tradeNo,proto3" json:"trade_no"`
	// * 卖家编号
	SellerId int32 `protobuf:"zigzag32,2,opt,name=seller_id,json=sellerId,proto3" json:"seller_id"`
	// * 交易类型
	TradeType string `protobuf:"bytes,3,opt,name=trade_type,json=tradeType,proto3" json:"trade_type"`
	// * 合并支付交单单号
	MergeTradeNo string `protobuf:"bytes,4,opt,name=merge_trade_no,json=mergeTradeNo,proto3" json:"merge_trade_no"`
	// * 支付单详情
	Subject string `protobuf:"bytes,5,opt,name=subject,proto3" json:"subject"`
	// * 是否为子订单
	SubOrder bool `protobuf:"varint,6,opt,name=sub_order,json=subOrder,proto3" json:"sub_order"`
	// * 支付单的类型，如购物或其他
	OrderType int32 `protobuf:"zigzag32,7,opt,name=order_type,json=orderType,proto3" json:"order_type"`
	// * 外部订单号
	OutOrderNo string `protobuf:"bytes,8,opt,name=out_order_no,json=outOrderNo,proto3" json:"out_order_no"`
	// * 买家编号
	BuyerId int32 `protobuf:"zigzag32,9,opt,name=buyer_id,json=buyerId,proto3" json:"buyer_id"`
	// * 支付用户编号
	PayUid int32 `protobuf:"zigzag32,10,opt,name=pay_uid,json=payUid,proto3" json:"pay_uid"`
	// * 商品金额
	ItemAmount int32 `protobuf:"zigzag32,11,opt,name=item_amount,json=itemAmount,proto3" json:"item_amount"`
	// * 优惠金额
	DiscountAmount int32 `protobuf:"zigzag32,12,opt,name=discount_amount,json=discountAmount,proto3" json:"discount_amount"`
	// * 调整金额
	AdjustAmount int32 `protobuf:"zigzag32,13,opt,name=adjust_amount,json=adjustAmount,proto3" json:"adjust_amount"`
	// * 抵扣金额
	DeductAmount int32 `protobuf:"zigzag32,14,opt,name=deduct_amount,json=deductAmount,proto3" json:"deduct_amount"`
	// * 共计金额
	TotalAmount int32 `protobuf:"zigzag32,15,opt,name=total_amount,json=totalAmount,proto3" json:"total_amount"`
	// * 手续费
	ProcedureFee int32 `protobuf:"zigzag32,16,opt,name=procedure_fee,json=procedureFee,proto3" json:"procedure_fee"`
	// * 实付金额
	PaidFee int32 `protobuf:"zigzag32,17,opt,name=paid_fee,json=paidFee,proto3" json:"paid_fee"`
	// * 最终应付金额
	FinalFee int32 `protobuf:"zigzag32,18,opt,name=final_fee,json=finalFee,proto3" json:"final_fee"`
	// * 可⽤支付方式
	PayFlag int32 `protobuf:"zigzag32,19,opt,name=pay_flag,json=payFlag,proto3" json:"pay_flag"`
	// * 实际使用支付方式
	FinalFlag int32 `protobuf:"zigzag32,20,opt,name=final_flag,json=finalFlag,proto3" json:"final_flag"`
	// * 其他支付信息
	ExtraData string `protobuf:"bytes,21,opt,name=extra_data,json=extraData,proto3" json:"extra_data"`
	// * 订单状态
	State int32 `protobuf:"zigzag32,22,opt,name=state,proto3" json:"state"`
	// * 提交时间
	SubmitTime int64 `protobuf:"zigzag64,23,opt,name=submit_time,json=submitTime,proto3" json:"submit_time"`
	// * 过期时间
	ExpiresTime int64 `protobuf:"zigzag64,24,opt,name=expires_time,json=expiresTime,proto3" json:"expires_time"`
	// * 支付时间
	PaidTime int64 `protobuf:"zigzag64,25,opt,name=paid_time,json=paidTime,proto3" json:"paid_time"`
	// * 交易数据
	TradeData []*STradeMethodData `protobuf:"bytes,26,rep,name=trade_data,json=tradeData,proto3" json:"trade_data"`
	// * 编号
...
func (*SPaymentOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_payment_service_4b8bee54f88850ed, []int{9}
}
...
func (*SRequestPayData) Descriptor() ([]byte, []int) {
	return fileDescriptor_payment_service_4b8bee54f88850ed, []int{10}
}
...
type STradeMethodData struct {
	...
	// * 外部交易单号
	OutTradeNo string `protobuf:"bytes,5,opt,name=out_trade_no,json=outTradeNo,proto3" json:"out_trade_no"`
	// * 支付时间
	PayTime              int64    `protobuf:"zigzag64,6,opt,name=pay_time,json=payTime,proto3" json:"pay_time"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*STradeMethodData) Descriptor() ([]byte, []int) {
	return fileDescriptor_payment_service_4b8bee54f88850ed, []int{11}
}
...
type SPrepareTradeData struct {
	...
	// * 支付标志
	PayFlag int32 `protobuf:"zigzag32,4,opt,name=pay_flag,json=payFlag,proto3" json:"pay_flag"`
	// * 交易状态
	TradeState int32 `protobuf:"zigzag32,5,opt,name=trade_state,json=tradeState,proto3" json:"trade_state"`
	// * 交易订单
	TradeOrders []*SPaymentOrderData `protobuf:"bytes,6,rep,name=trade_orders,json=tradeOrders,proto3" json:"trade_orders"`
	// * 累计金额
	TotalAmount int32 `protobuf:"zigzag32,7,opt,name=total_amount,json=totalAmount,proto3" json:"total_amount"`
	// * 手续费
	ProcedureFee int32 `protobuf:"zigzag32,8,opt,name=procedure_fee,json=procedureFee,proto3" json:"procedure_fee"`
	// * 最终支付金额
	FinalFee             int32    `protobuf:"zigzag32,9,opt,name=final_fee,json=finalFee,proto3" json:"final_fee"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*SPrepareTradeData) Descriptor() ([]byte, []int) {
	return fileDescriptor_payment_service_4b8bee54f88850ed, []int{12}
}
...
type SPaymentOrderData struct {
	...
	// * 手续费
	ProcedureFee int32 `protobuf:"zigzag32,5,opt,name=procedure_fee,json=procedureFee,proto3" json:"procedure_fee"`
	// * 最终支付金额
	FinalFee             int32    `protobuf:"zigzag32,6,opt,name=final_fee,json=finalFee,proto3" json:"final_fee"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*SPaymentOrderData) Descriptor() ([]byte, []int) {
	return fileDescriptor_payment_service_4b8bee54f88850ed, []int{13}
}
...
func init() {
	proto.RegisterFile("payment_service.proto", fileDescriptor_payment_service_4b8bee54f88850ed)
}

var fileDescriptor_payment_service_4b8bee54f88850ed = []byte{
	...
	,
}
