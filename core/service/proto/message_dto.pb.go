...
func (EMessageChannel) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_message_dto_a7c600b68be8c069, []int{0}
}
...
func (EMessageUserType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_message_dto_a7c600b68be8c069, []int{1}
}
...
func (*SNotifyItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_dto_a7c600b68be8c069, []int{2}
}
...
func (*SMailTemplate) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_dto_a7c600b68be8c069, []int{3}
}
...
func (*MailTemplateListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_dto_a7c600b68be8c069, []int{4}
}
...
func (*SSiteMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_dto_a7c600b68be8c069, []int{5}
}
...
func (*SendSiteMessageRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_dto_a7c600b68be8c069, []int{6}
}
...
func init() {
	proto.RegisterFile("message/message_dto.proto", fileDescriptor_message_dto_a7c600b68be8c069)
}

var fileDescriptor_message_dto_a7c600b68be8c069 = []byte{
