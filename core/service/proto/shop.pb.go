...
func (*SShop) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_c36624d01b1b77af, []int{0}
}
...
func (*SShopConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_c36624d01b1b77af, []int{1}
}
...
func (*ShopId) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_c36624d01b1b77af, []int{2}
}
...
func (*StoreId) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_c36624d01b1b77af, []int{3}
}
...
func (*SStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_c36624d01b1b77af, []int{4}
}
...
func (*CheckShopResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_c36624d01b1b77af, []int{5}
}
...
func init() { proto.RegisterFile("message/shop.proto", fileDescriptor_shop_c36624d01b1b77af) }

var fileDescriptor_shop_c36624d01b1b77af = []byte{
