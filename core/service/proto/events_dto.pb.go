...
type EVSendSmsEventData struct {
	...
	// 数据
	Data []string `protobuf:"bytes,5,rep,name=data,proto3" json:"data"`
}
...
func (x *EVSendSmsEventData) GetProvider() string {
	if x != nil {
		return x.Provider
	}
	return ""
...
var file_message_events_dto_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x96, 0x01, 0x0a, 0x12, 0x45, 0x56, 0x53, 0x65,
