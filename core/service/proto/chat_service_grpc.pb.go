...
const (
	...
	ChatService_FetchHistoryMsgList_FullMethodName = "/ChatService/fetchHistoryMsgList"
...
type ChatServiceClient interface {
	// 获取聊天会话
	GetConversation(ctx context.Context, in *ChatConversationRequest, opts ...grpc.CallOption) (*SConversation, error)
	// 删除会话
	...
	// 获取历史消息
	FetchHistoryMsgList(ctx context.Context, in *FetchMsgRequest, opts ...grpc.CallOption) (*FetchMsgResponse, error)
	// 获取最近的消息
...
func (c *chatServiceClient) GetConversation(ctx context.Context, in *ChatConversationRequest, opts ...grpc.CallOption) (*SConversation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SConversation)
...
func (c *chatServiceClient) FetchHistoryMsgList(ctx context.Context, in *FetchMsgRequest, opts ...grpc.CallOption) (*FetchMsgResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FetchMsgResponse)
	err := c.cc.Invoke(ctx, ChatService_FetchHistoryMsgList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatServiceServer interface {
	// 获取聊天会话
	GetConversation(context.Context, *ChatConversationRequest) (*SConversation, error)
	// 删除会话
	...
	// 获取历史消息
	FetchHistoryMsgList(context.Context, *FetchMsgRequest) (*FetchMsgResponse, error)
	// 获取最近的消息
...
func (UnimplementedChatServiceServer) GetConversation(context.Context, *ChatConversationRequest) (*SConversation, error) {
...
func (UnimplementedChatServiceServer) FetchHistoryMsgList(context.Context, *FetchMsgRequest) (*FetchMsgResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FetchHistoryMsgList not implemented")
}
...
func _ChatService_FetchHistoryMsgList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FetchMsgRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).FetchHistoryMsgList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatService_FetchHistoryMsgList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).FetchHistoryMsgList(ctx, req.(*FetchMsgRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "fetchHistoryMsgList",
			Handler:    _ChatService_FetchHistoryMsgList_Handler,
		},
		{
