...
func (*SShop2) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_service_9a78cd27ff2e22a3, []int{0}
}
...
func (*SShop) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_service_9a78cd27ff2e22a3, []int{1}
}
...
func (*SStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_service_9a78cd27ff2e22a3, []int{2}
}
...
func (*TurnShopRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_service_9a78cd27ff2e22a3, []int{3}
}
...
type ShopServiceClient interface {
	// * 查询店铺ID,根据Host
	QueryShopIdByHost(ctx context.Context, in *String, opts ...grpc.CallOption) (*Int32, error)
	// * 获取店铺,shopId
	GetShop(ctx context.Context, in *Int32, opts ...grpc.CallOption) (*SShop, error)
	// * 获取商户的店铺,vendorId
	GetVendorShop(ctx context.Context, in *Int32, opts ...grpc.CallOption) (*SShop, error)
	// * 获取门店,storeId
	GetStore(ctx context.Context, in *Int32, opts ...grpc.CallOption) (*SStore, error)
	// * 根据主机头获取店铺编号,host
	QueryShopByHost(ctx context.Context, in *String, opts ...grpc.CallOption) (*Int32, error)
	// 获取门店
...
func (c *shopServiceClient) QueryShopIdByHost(ctx context.Context, in *String, opts ...grpc.CallOption) (*Int32, error) {
	out := new(Int32)
	err := c.cc.Invoke(ctx, "/ShopService/QueryShopIdByHost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shopServiceClient) GetShop(ctx context.Context, in *Int32, opts ...grpc.CallOption) (*SShop, error) {
	out := new(SShop)
...
func (c *shopServiceClient) GetVendorShop(ctx context.Context, in *Int32, opts ...grpc.CallOption) (*SShop, error) {
	out := new(SShop)
...
func (c *shopServiceClient) GetStore(ctx context.Context, in *Int32, opts ...grpc.CallOption) (*SStore, error) {
	out := new(SStore)
...
func (c *shopServiceClient) QueryShopByHost(ctx context.Context, in *String, opts ...grpc.CallOption) (*Int32, error) {
	out := new(Int32)
...
type ShopServiceServer interface {
	// * 查询店铺ID,根据Host
	QueryShopIdByHost(context.Context, *String) (*Int32, error)
	// * 获取店铺,shopId
	GetShop(context.Context, *Int32) (*SShop, error)
	// * 获取商户的店铺,vendorId
	GetVendorShop(context.Context, *Int32) (*SShop, error)
	// * 获取门店,storeId
	GetStore(context.Context, *Int32) (*SStore, error)
	// * 根据主机头获取店铺编号,host
	QueryShopByHost(context.Context, *String) (*Int32, error)
	// 获取门店
	// rpc GetOfflineShop(1:sint32 shopId)returns(Shop)
	// 打开或关闭商店
...
func _ShopService_QueryShopIdByHost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(String)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShopServiceServer).QueryShopIdByHost(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ShopService/QueryShopIdByHost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShopServiceServer).QueryShopIdByHost(ctx, req.(*String))
	}
...
func _ShopService_GetShop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShopServiceServer).GetShop(ctx, req.(*Int32))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ShopService_GetVendorShop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShopServiceServer).GetVendorShop(ctx, req.(*Int32))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ShopService_GetStore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShopServiceServer).GetStore(ctx, req.(*Int32))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ShopService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "QueryShopIdByHost",
			Handler:    _ShopService_QueryShopIdByHost_Handler,
		},
		{
			MethodName: "GetShop",
...
func init() { proto.RegisterFile("shop_service.proto", fileDescriptor_shop_service_9a78cd27ff2e22a3) }

var fileDescriptor_shop_service_9a78cd27ff2e22a3 = []byte{
	// 580 bytes of a gzipped FileDescriptorProto
	,
}
