...
func (*SShop2) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_service_088feeee033a2c1d, []int{0}
}
...
func (*SShop) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_service_088feeee033a2c1d, []int{1}
}
...
func (*SStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_service_088feeee033a2c1d, []int{2}
}
...
func (*TurnShopRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_service_088feeee033a2c1d, []int{3}
}
...
func init() { proto.RegisterFile("shop_service.proto", fileDescriptor_shop_service_088feeee033a2c1d) }

var fileDescriptor_shop_service_088feeee033a2c1d = []byte{
	// 568 bytes of a gzipped FileDescriptorProto
	,
}
