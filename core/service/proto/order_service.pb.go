...
var file_order_service_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x5f, 0x64, 0x74, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x98, 0x07, 0x0a,
	0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x32, 0x0a,
	0x0d, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x56, 0x32, 0x12, 0x13,
...
var file_order_service_proto_goTypes = []interface{}{
	...
	(*StringMap)(nil),                  // 12: StringMap
	(*PrepareOrderResponse)(nil),       // 13: PrepareOrderResponse
	(*NormalOrderSubmitResponse)(nil),  // 14: NormalOrderSubmitResponse
	(*SParentOrder)(nil),               // 15: SParentOrder
	(*SSingleOrder)(nil),               // 16: SSingleOrder
...
var file_order_service_proto_depIdxs = []int32{
	0,  // 0: OrderService.SubmitOrderV2:input_type -> SubmitOrderRequest
	...
	8,  // 15: OrderService.forbid:input_type -> OrderNo
	8,  // 16: OrderService.LogBytes:input_type -> OrderNo
	11, // 17: OrderService.QueryRebateListList:input_type -> QueryRebateListRequest
	12, // 18: OrderService.SubmitOrderV2:output_type -> StringMap
	13, // 19: OrderService.PrepareOrder:output_type -> PrepareOrderResponse
	14, // 20: OrderService.SubmitNormalOrder_:output_type -> NormalOrderSubmitResponse
	15, // 21: OrderService.GetParentOrder:output_type -> SParentOrder
	16, // 22: OrderService.GetOrder:output_type -> SSingleOrder
	17, // 23: OrderService.SubmitTradeOrder:output_type -> Result
	17, // 24: OrderService.TradeOrderCashPay:output_type -> Result
	17, // 25: OrderService.TradeOrderUpdateTicket:output_type -> Result
	12, // 26: OrderService.PrepareOrderWithCoupon_:output_type -> StringMap
	17, // 27: OrderService.CancelOrder:output_type -> Result
	17, // 28: OrderService.ConfirmOrder:output_type -> Result
	17, // 29: OrderService.ChangeShipmentAddress:output_type -> Result
	17, // 30: OrderService.PickUp:output_type -> Result
	17, // 31: OrderService.Ship:output_type -> Result
	17, // 32: OrderService.BuyerReceived:output_type -> Result
	17, // 33: OrderService.forbid:output_type -> Result
	18, // 34: OrderService.LogBytes:output_type -> String
	19, // 35: OrderService.QueryRebateListList:output_type -> QueryRebateListResponse
