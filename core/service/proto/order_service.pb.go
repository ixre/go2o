...
var file_order_service_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x5f, 0x64, 0x74, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xa8, 0x07, 0x0a,
...
var file_order_service_proto_depIdxs = []int32{
	...
	12, // 18: OrderService.SubmitOrderV2:output_type -> NormalOrderSubmitResponse
	13, // 19: OrderService.PrepareOrder:output_type -> PrepareOrderResponse
	12, // 20: OrderService.SubmitNormalOrder_:output_type -> NormalOrderSubmitResponse
	14, // 21: OrderService.GetParentOrder:output_type -> SParentOrder
	15, // 22: OrderService.GetOrder:output_type -> SSingleOrder
	16, // 23: OrderService.SubmitTradeOrder:output_type -> Result
	16, // 24: OrderService.TradeOrderCashPay:output_type -> Result
	16, // 25: OrderService.TradeOrderUpdateTicket:output_type -> Result
	17, // 26: OrderService.PrepareOrderWithCoupon_:output_type -> StringMap
	16, // 27: OrderService.CancelOrder:output_type -> Result
	16, // 28: OrderService.ConfirmOrder:output_type -> Result
	16, // 29: OrderService.ChangeShipmentAddress:output_type -> Result
	16, // 30: OrderService.PickUp:output_type -> Result
	16, // 31: OrderService.Ship:output_type -> Result
	16, // 32: OrderService.BuyerReceived:output_type -> Result
	16, // 33: OrderService.forbid:output_type -> Result
