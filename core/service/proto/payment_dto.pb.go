...
func (PaymentAccountType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_payment_dto_68ab8c49fb4bfade, []int{0}
}
...
func init() {
	proto.RegisterFile("message/payment_dto.proto", fileDescriptor_payment_dto_68ab8c49fb4bfade)
}

var fileDescriptor_payment_dto_68ab8c49fb4bfade = []byte{
