...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  SSku GetSku(i64 itemId, i64 skuId)")
...
func main() {
	...
	client := item_service.NewItemServiceClient(thrift.NewTStandardClient(iprot, oprot))
	...
	case "GetSku":
		...
		value1 := argvalue1
		fmt.Print(client.GetSku(context.Background(), value0, value1))
		fmt.Print("\n")
		break
	case "GetItemSkuJson":
		if flag.NArg()-1 != 1 {
		...
		value0 := argvalue0
		fmt.Print(client.GetItemSkuJson(context.Background(), value0))
		fmt.Print("\n")
		break
	case "GetItemDetailData":
		...
		value1 := argvalue1
		fmt.Print(client.GetItemDetailData(context.Background(), value0, value1))
		fmt.Print("\n")
		break
	case "":
		Usage()
