...
type SMemberLevelInfo struct {
  ...
  NextLevel int32 `thrift:"NextLevel,4" db:"NextLevel" json:"NextLevel"`
  NextLevelName string `thrift:"NextLevelName,5" db:"NextLevelName" json:"NextLevelName"`
  RequireExp int32 `thrift:"RequireExp,6" db:"RequireExp" json:"RequireExp"`
}
...
func (p *SMemberLevelInfo) writeField4(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("NextLevel", thrift.I32, 4); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:NextLevel: ", p), err) }
  if err := oprot.WriteI32(int32(p.NextLevel)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.NextLevel (4) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 4:NextLevel: ", p), err) }
  return err
}

func (p *SMemberLevelInfo) writeField5(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("NextLevelName", thrift.STRING, 5); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:NextLevelName: ", p), err) }
  if err := oprot.WriteString(string(p.NextLevelName)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.NextLevelName (5) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 5:NextLevelName: ", p), err) }
  return err
}

func (p *SMemberLevelInfo) writeField6(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("RequireExp", thrift.I32, 6); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:RequireExp: ", p), err) }
  if err := oprot.WriteI32(int32(p.RequireExp)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.RequireExp (6) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 6:RequireExp: ", p), err) }
  return err
}
