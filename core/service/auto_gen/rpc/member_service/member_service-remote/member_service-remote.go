...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  Result RegisterMemberV1(SMember member, SProfile profile, i32 mchId, string cardId, string inviteCode)")
...
func main() {
  ...
  case "RegisterMemberV1":
    ...
    argvalue0 := member_service.NewSMember()
    err75 := argvalue0.Read(jsProt74)
    if err75 != nil {
      Usage()
      return
    }
    value0 := member_service.SMember(argvalue0)
    arg76 := flag.Arg(2)
    ...
    argvalue1 := member_service.NewSProfile()
    err81 := argvalue1.Read(jsProt80)
    if err81 != nil {
      Usage()
      return
    }
    value1 := member_service.SProfile(argvalue1)
