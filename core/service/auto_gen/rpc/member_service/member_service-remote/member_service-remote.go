...
func main() {
	...
	case "UpdateLevel":
		...
		argvalue2 := flag.Arg(3) == "true"
		value2 := argvalue2
		argvalue3, err161 := (strconv.ParseInt(flag.Arg(4), 10, 64))
		if err161 != nil {
			Usage()
			return
		}
	...
	case "AccountCharge":
		...
		argvalue2 := flag.Arg(3)
		value2 := argvalue2
		tmp3, err199 := (strconv.Atoi(flag.Arg(4)))
		if err199 != nil {
			Usage()
			return
		}
	...
	case "AccountDiscount":
		...
		value0 := argvalue0
		tmp1, err209 := (strconv.Atoi(flag.Arg(2)))
		if err209 != nil {
			Usage()
			return
		}
		...
		argvalue2 := flag.Arg(3)
		value2 := argvalue2
		tmp3, err211 := (strconv.Atoi(flag.Arg(4)))
		if err211 != nil {
			Usage()
			return
		}
	...
	case "AccountRefund":
		...
		value0 := argvalue0
		tmp1, err215 := (strconv.Atoi(flag.Arg(2)))
		if err215 != nil {
			Usage()
			return
		}
	...
	case "B4EAuth":
		...
		err232 := containerStruct2.ReadField3(jsProt231)
		if err232 != nil {
			Usage()
			return
		}
	...
	case "PagingAccountLog":
		...
		value0 := argvalue0
		tmp1, err234 := (strconv.Atoi(flag.Arg(2)))
		if err234 != nil {
			Usage()
			return
		}
		...
		err240 := argvalue2.Read(jsProt239)
		if err240 != nil {
			Usage()
			return
		}
