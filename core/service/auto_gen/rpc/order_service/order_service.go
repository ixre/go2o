...
func (p EOrderState) String() string {
	switch p {
	case EOrderState_StatAwaitingPayment:
		return "StatAwaitingPayment"
	case EOrderState_StatAwaitingConfirm:
		return "StatAwaitingConfirm"
	case EOrderState_StatAwaitingPickup:
		return "StatAwaitingPickup"
	case EOrderState_StatAwaitingShipment:
		return "StatAwaitingShipment"
	case EOrderState_StatCancelled:
		return "StatCancelled"
	case EOrderState_StatAwaitingCancel:
		return "StatAwaitingCancel"
	case EOrderState_StatDeclined:
		return "StatDeclined"
	case EOrderState_StatRefunded:
		return "StatRefunded"
	case EOrderState_PartiallyShipped:
		return "PartiallyShipped"
	case EOrderState_StatShipped:
		return "StatShipped"
	case EOrderState_StatBreak:
		return "StatBreak"
	case EOrderState_StatCompleted:
		return "StatCompleted"
	case EOrderState_StatGoodsRefunded:
		return "StatGoodsRefunded"
	}
	return "<UNSET>"
}
...
func EOrderStateFromString(s string) (EOrderState, error) {
	...
	case "StatAwaitingPayment":
		return EOrderState_StatAwaitingPayment, nil
	case "StatAwaitingConfirm":
		return EOrderState_StatAwaitingConfirm, nil
	case "StatAwaitingPickup":
		return EOrderState_StatAwaitingPickup, nil
	case "StatAwaitingShipment":
		return EOrderState_StatAwaitingShipment, nil
	case "StatCancelled":
		return EOrderState_StatCancelled, nil
	case "StatAwaitingCancel":
		return EOrderState_StatAwaitingCancel, nil
	case "StatDeclined":
		return EOrderState_StatDeclined, nil
	case "StatRefunded":
		return EOrderState_StatRefunded, nil
	case "PartiallyShipped":
		return EOrderState_PartiallyShipped, nil
	case "StatShipped":
		return EOrderState_StatShipped, nil
	case "StatBreak":
		return EOrderState_StatBreak, nil
	case "StatCompleted":
		return EOrderState_StatCompleted, nil
	case "StatGoodsRefunded":
		return EOrderState_StatGoodsRefunded, nil
	}
