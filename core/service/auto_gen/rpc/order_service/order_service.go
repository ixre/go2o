...
type OrderService interface {
  ...
  //  - Action
  //  - Data
  RetailCartV1(ctx context.Context, memberId int64, action string, data map[string]string) (r *ttype.Result_, err error)
  // Parameters:
  //  - BuyerId
  //  - CartType
  //  - Data
...
//  - Action
//  - Data
func (p *OrderServiceClient) RetailCartV1(ctx context.Context, memberId int64, action string, data map[string]string) (r *ttype.Result_, err error) {
...
var OrderServiceRetailCartV1Result_Success_DEFAULT *ttype.Result_
func (p *OrderServiceRetailCartV1Result) GetSuccess() *ttype.Result_ {
  if !p.IsSetSuccess() {
