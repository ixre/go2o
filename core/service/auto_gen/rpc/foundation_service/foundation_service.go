...
type SRegistry struct {
  ...
  UserDefine bool `thrift:"UserDefine,5" db:"UserDefine" json:"UserDefine"`
...
func (p *SRegistry) GetUserDefine() bool {
  return p.UserDefine
}
...
func (p *SRegistry) writeField5(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("UserDefine", thrift.BOOL, 5); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:UserDefine: ", p), err) }
  if err := oprot.WriteBool(bool(p.UserDefine)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.UserDefine (5) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 5:UserDefine: ", p), err) }
  return err
}
...
func (p *FoundationServiceClient) ResourceUrl(ctx context.Context, url string) (r string, err error) {
  var _args12 FoundationServiceResourceUrlArgs
  _args12.URL = url
  var _result13 FoundationServiceResourceUrlResult
  if err = p.Client_().Call(ctx, "ResourceUrl", &_args12, &_result13); err != nil {
    return
  }
...
func (p *FoundationServiceClient) SetValue(ctx context.Context, key string, value string) (r *ttype.Result_, err error) {
  var _args14 FoundationServiceSetValueArgs
  _args14.Key = key
  _args14.Value = value
  var _result15 FoundationServiceSetValueResult
  if err = p.Client_().Call(ctx, "SetValue", &_args14, &_result15); err != nil {
    return
  }
...
func (p *FoundationServiceClient) DeleteValue(ctx context.Context, key string) (r *ttype.Result_, err error) {
  var _args16 FoundationServiceDeleteValueArgs
  _args16.Key = key
  var _result17 FoundationServiceDeleteValueResult
  if err = p.Client_().Call(ctx, "DeleteValue", &_args16, &_result17); err != nil {
    return
  }
...
func (p *FoundationServiceClient) GetRegistryV1(ctx context.Context, keys []string) (r []string, err error) {
  var _args18 FoundationServiceGetRegistryV1Args
  _args18.Keys = keys
  var _result19 FoundationServiceGetRegistryV1Result
  if err = p.Client_().Call(ctx, "GetRegistryV1", &_args18, &_result19); err != nil {
    return
  }
...
func (p *FoundationServiceClient) GetValuesByPrefix(ctx context.Context, prefix string) (r map[string]string, err error) {
  var _args20 FoundationServiceGetValuesByPrefixArgs
  _args20.Prefix = prefix
  var _result21 FoundationServiceGetValuesByPrefixResult
  if err = p.Client_().Call(ctx, "GetValuesByPrefix", &_args20, &_result21); err != nil {
    return
  }
...
func (p *FoundationServiceClient) RegisterApp(ctx context.Context, app *SSsoApp) (r string, err error) {
  var _args22 FoundationServiceRegisterAppArgs
  _args22.App = app
  var _result23 FoundationServiceRegisterAppResult
  if err = p.Client_().Call(ctx, "RegisterApp", &_args22, &_result23); err != nil {
    return
  }
...
func (p *FoundationServiceClient) GetApp(ctx context.Context, name string) (r *SSsoApp, err error) {
  var _args24 FoundationServiceGetAppArgs
  _args24.Name = name
  var _result25 FoundationServiceGetAppResult
  if err = p.Client_().Call(ctx, "GetApp", &_args24, &_result25); err != nil {
    return
  }
...
func (p *FoundationServiceClient) GetAllSsoApp(ctx context.Context) (r []string, err error) {
  var _args26 FoundationServiceGetAllSsoAppArgs
  var _result27 FoundationServiceGetAllSsoAppResult
  if err = p.Client_().Call(ctx, "GetAllSsoApp", &_args26, &_result27); err != nil {
    return
  }
...
func (p *FoundationServiceClient) SuperValidate(ctx context.Context, user string, pwd string) (r bool, err error) {
  var _args28 FoundationServiceSuperValidateArgs
  _args28.User = user
  _args28.Pwd = pwd
  var _result29 FoundationServiceSuperValidateResult
  if err = p.Client_().Call(ctx, "SuperValidate", &_args28, &_result29); err != nil {
    return
  }
...
func (p *FoundationServiceClient) FlushSuperPwd(ctx context.Context, user string, pwd string) (err error) {
  var _args30 FoundationServiceFlushSuperPwdArgs
  _args30.User = user
  _args30.Pwd = pwd
  var _result31 FoundationServiceFlushSuperPwdResult
  if err = p.Client_().Call(ctx, "FlushSuperPwd", &_args30, &_result31); err != nil {
    return
  }
  return nil
}
...
func (p *FoundationServiceClient) GetSyncLoginUrl(ctx context.Context, returnUrl string) (r string, err error) {
  var _args32 FoundationServiceGetSyncLoginUrlArgs
  _args32.ReturnUrl = returnUrl
  var _result33 FoundationServiceGetSyncLoginUrlResult
  if err = p.Client_().Call(ctx, "GetSyncLoginUrl", &_args32, &_result33); err != nil {
    return
  }
...
func (p *FoundationServiceClient) GetAreaNames(ctx context.Context, codes []int32) (r []string, err error) {
  var _args34 FoundationServiceGetAreaNamesArgs
  _args34.Codes = codes
  var _result35 FoundationServiceGetAreaNamesResult
  if err = p.Client_().Call(ctx, "GetAreaNames", &_args34, &_result35); err != nil {
    return
  }
...
func (p *FoundationServiceClient) GetChildAreas(ctx context.Context, code int32) (r []*SArea, err error) {
  var _args36 FoundationServiceGetChildAreasArgs
  _args36.Code = code
  var _result37 FoundationServiceGetChildAreasResult
  if err = p.Client_().Call(ctx, "GetChildAreas", &_args36, &_result37); err != nil {
    return
  }
...
func NewFoundationServiceProcessor(handler FoundationService) *FoundationServiceProcessor {
  ...
  self38 := &FoundationServiceProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self38.processorMap["GetRegistry"] = &foundationServiceProcessorGetRegistry{handler:handler}
  self38.processorMap["GetRegistries"] = &foundationServiceProcessorGetRegistries{handler:handler}
  self38.processorMap["findRegistries"] = &foundationServiceProcessorFindRegistries{handler:handler}
  self38.processorMap["UpdateRegistry"] = &foundationServiceProcessorUpdateRegistry{handler:handler}
  self38.processorMap["SearchRegistry"] = &foundationServiceProcessorSearchRegistry{handler:handler}
  self38.processorMap["CreateUserRegistry"] = &foundationServiceProcessorCreateUserRegistry{handler:handler}
  self38.processorMap["ResourceUrl"] = &foundationServiceProcessorResourceUrl{handler:handler}
  self38.processorMap["SetValue"] = &foundationServiceProcessorSetValue{handler:handler}
  self38.processorMap["DeleteValue"] = &foundationServiceProcessorDeleteValue{handler:handler}
  self38.processorMap["GetRegistryV1"] = &foundationServiceProcessorGetRegistryV1{handler:handler}
  self38.processorMap["GetValuesByPrefix"] = &foundationServiceProcessorGetValuesByPrefix{handler:handler}
  self38.processorMap["RegisterApp"] = &foundationServiceProcessorRegisterApp{handler:handler}
  self38.processorMap["GetApp"] = &foundationServiceProcessorGetApp{handler:handler}
  self38.processorMap["GetAllSsoApp"] = &foundationServiceProcessorGetAllSsoApp{handler:handler}
  self38.processorMap["SuperValidate"] = &foundationServiceProcessorSuperValidate{handler:handler}
  self38.processorMap["FlushSuperPwd"] = &foundationServiceProcessorFlushSuperPwd{handler:handler}
  self38.processorMap["GetSyncLoginUrl"] = &foundationServiceProcessorGetSyncLoginUrl{handler:handler}
  self38.processorMap["GetAreaNames"] = &foundationServiceProcessorGetAreaNames{handler:handler}
  self38.processorMap["GetChildAreas"] = &foundationServiceProcessorGetChildAreas{handler:handler}
return self38
}
...
var _elem53 int32
    ...
    p.Codes = append(p.Codes, _elem53)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
