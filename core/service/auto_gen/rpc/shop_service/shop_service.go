...
// Deprecated: Use NewShopService instead
...
func (p *ShopServiceClient) GetStore(ctx context.Context, venderId int32) (r *SStore, err error) {
  ...
  if err = p.c.Call(ctx, "GetStore", &_args2, &_result3); err != nil {
    return
  }
...
func (p *ShopServiceClient) GetStoreById(ctx context.Context, shopId int32) (r *SStore, err error) {
  ...
  if err = p.c.Call(ctx, "GetStoreById", &_args4, &_result5); err != nil {
    return
  }
...
func (p *ShopServiceClient) TurnShop(ctx context.Context, shopId int32, on bool, reason string) (r *ttype.Result_, err error) {
  ...
  if err = p.c.Call(ctx, "TurnShop", &_args6, &_result7); err != nil {
    return
  }
...
func (p *ShopServiceClient) OpenShop(ctx context.Context, shopId int32, opening bool, reason string) (r *ttype.Result_, err error) {
  ...
  if err = p.c.Call(ctx, "OpenShop", &_args8, &_result9); err != nil {
    return
  }
