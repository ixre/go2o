...
func main() {
	...
	switch cmd {
	case "QueryShopIdByHost":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "QueryShopIdByHost requires 1 args")
			flag.Usage()
		}
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.QueryShopIdByHost(context.Background(), value0))
		fmt.Print("\n")
		break
	case "GetShop":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "GetShop requires 1 args")
			flag.Usage()
		}
