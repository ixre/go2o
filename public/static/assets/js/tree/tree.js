...
// Node object
//
//改为url,另外返回dtree对象,handler为函数

function Node(id, pid, name, url, title,value,target, icon, iconOpen, open) {
...
function dTree(objName, iconPath) {
    ...
    var _pt = this.config.iconPath;

    this.icon = {

        root: _pt + 'img/base.gif',

        folder: _pt + 'img/folder.gif',

        folderOpen: _pt + 'img/folderopen.gif',

        node: _pt + 'img/page.gif',

        empty: _pt + 'img/empty.gif',

        line: _pt + 'img/line.gif',

        join: _pt + 'img/join.gif',

        joinBottom: _pt + 'img/joinbottom.gif',

        plus: _pt + 'img/plus.gif',

        plusBottom: _pt + 'img/plusbottom.gif',

        minus: _pt + 'img/minus.gif',

        minusBottom: _pt + 'img/minusbottom.gif',

        nlPlus: _pt + 'img/nolines_plus.gif',

        nlMinus: _pt + 'img/nolines_minus.gif'
...
dTree.prototype.add = function (id, pid, name, url, title,value, target, icon, iconOpen, open) {
    this.aNodes[this.aNodes.length] = new Node(id, pid, name, url, title,value, target, icon, iconOpen, open);
};
...
dTree.prototype.bind = function (json,completeFunc) {
    ...
    load(json, 0);
	if(completeFunc && completeFunc instanceof Function)completeFunc();
};
...
dTree.prototype.toString = function () {
    ...
    var str = '<div class="ui-tree dtree">\n';
...
dTree.prototype.node = function (node, nodeId) {
    ...
    if (node.url) {
        ...
        if (this.config.useSelection && ((node._hc && this.config.folderLinks) || !node._hc))
            ...
            str += ' onclick="javascript: ' + this.obj + '.s(' + nodeId + ');" node-value="'+node.value+'"';
        ...
        str += '<a href="javascript: ' + this.obj + '.o(' + nodeId + ');" class="node" node-value="'+node.value+'">';
