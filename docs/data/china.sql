...
//清除市辖区
UPDATE china SET pid = pid-1
UPDATE pid IN (SELECT * FROM (SELECT id FROM china where Name='市辖区') t);
DELETE FROM china WHERE id IN (SELECT * FROM (SELECT id FROM china where Name='市辖区') t);
DELETE FROM china WHERE pid IS NULL;
*/
