...
--
-- Host: db.go2o-dev.56x.net    Database:go2o
-- ------------------------------------------------------
-- Server version	5.5.5-10.0.23-MariaDB-0+deb8u1
...
--
-- Dumping data for table `china_area`
--

LOCK
TABLES `china_area` WRITE;
...
-- Dump completed on 2016-06-12 20:46:34
