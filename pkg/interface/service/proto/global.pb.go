...
type StringMap struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Value         map[string]string      `protobuf:"bytes,1,rep,name=value,proto3" json:"value" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SPagingParams struct {
	...
	// 参数
	Parameters    map[string]string `protobuf:"bytes,6,rep,name=parameters,proto3" json:"parameters" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SPagingResult struct {
	...
	// * 额外的数据
	Extras        map[string]string `protobuf:"bytes,5,rep,name=extras,proto3" json:"extras" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type STreeNode struct {
	...
	// 其他数据
	Data map[string]string `protobuf:"bytes,6,rep,name=data,proto3" json:"data" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// 子节点
...
const file_global_proto_rawDesc = "" +
	...
	"\x05Int32\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x11R\x05value\"\x1c\n" +
	"\x04Bool\x12\x14\n" +
	"\x05value\x18\x01 \x01(\bR\x05value\"r\n" +
	"\tStringMap\x12+\n" +
	"\x05value\x18\x01 \x03(\v2\x15.StringMap.ValueEntryR\x05value\x1a8\n" +
	"\n" +
	"ValueEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"#\n" +
	"\vStringArray\x12\x14\n" +
	"\x05value\x18\x01 \x03(\tR\x05value\"\x9a\x01\n" +
	"\x06Result\x12\x18\n" +
	"\aerrCode\x18\x01 \x01(\x11R\aerrCode\x12\x16\n" +
	"\x06errMsg\x18\x02 \x01(\tR\x06errMsg\x12%\n" +
	"\x04data\x18\x03 \x03(\v2\x11.Result.DataEntryR\x04data\x1a7\n" +
	"\tDataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x04txId\x18\x03 \x01(\x03R\x04txId\x12'\n" +
	"\x04data\x18\x04 \x03(\v2\x13.TxResult.DataEntryR\x04data\x1a7\n" +
	"\tDataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\".\n" +
	"\x04Pair\x12\x10\n" +
	...
	"\vIdAndRemark\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x16\n" +
	"\x06remark\x18\x02 \x01(\tR\x06remark\"\x84\x02\n" +
	"\rSPagingParams\x12\x14\n" +
	"\x05begin\x18\x01 \x01(\x12R\x05begin\x12\x10\n" +
	"\x03end\x18\x02 \x01(\x12R\x03end\x12\x14\n" +
	"\x05where\x18\x03 \x01(\tR\x05where\x12\x16\n" +
	"\x06sortBy\x18\x04 \x01(\tR\x06sortBy\x12\x1e\n" +
	"\n" +
	"countTotal\x18\x05 \x01(\bR\n" +
	"countTotal\x12>\n" +
	"\n" +
	"parameters\x18\x06 \x03(\v2\x1e.SPagingParams.ParametersEntryR\n" +
	"parameters\x1a=\n" +
	"\x0fParametersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xda\x01\n" +
	"\rSPagingResult\x12\x18\n" +
	"\aerrCode\x18\x01 \x01(\x11R\aerrCode\x12\x16\n" +
	"\x06errMsg\x18\x02 \x01(\tR\x06errMsg\x12\x14\n" +
	"\x05count\x18\x03 \x01(\x11R\x05count\x12\x12\n" +
	"\x04data\x18\x04 \x01(\tR\x04data\x122\n" +
	"\x06extras\x18\x05 \x03(\v2\x1a.SPagingResult.ExtrasEntryR\x06extras\x1a9\n" +
	...
	"\x06expand\x18\x04 \x01(\bR\x06expand\x12\x12\n" +
	"\x04lazy\x18\x05 \x01(\bR\x04lazy\x12(\n" +
	"\x04data\x18\x06 \x03(\v2\x14.STreeNode.DataEntryR\x04data\x12&\n" +
	"\bchildren\x18\a \x03(\v2\n" +
	".STreeNodeR\bchildren\x12\x16\n" +
	"\x06isLeaf\x18\b \x01(\bR\x06isLeaf\x1a7\n" +
	"\tDataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\aBuyerId\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x03R\x05value*1\n" +
	"\rESettingBasis\x12\b\n" +
	"\x04None\x10\x00\x12\n" +
	"\n" +
	...
	"\x06Custom\x10\x02*G\n" +
	"\vEPriceBasis\x12\v\n" +
	"\a_Unused\x10\x00\x12\f\n" +
	"\bOriginal\x10\x01\x12\f\n" +
	"\bDiscount\x10\x02\x12\x0f\n" +
	"\vCustomBasis\x10\x03*<\n" +
	"\fEAmountBasis\x12\a\n" +
	"\x03_12\x10\x00\x12\n" +
	"\n" +
	"\x06NotSet\x10\x01\x12\n" +
	"\n" +
	"\x06Amount\x10\x02\x12\v\n" +
	"\aPercent\x10\x03B\x1f\n" +
