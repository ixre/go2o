...
func (UnimplementedRegistryServiceServer) UpdateValues(context.Context, *StringMap) (*TxResult, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateValues not implemented")
}
...
func (UnimplementedRegistryServiceServer) FindRegistries(context.Context, *String) (*StringMap, error) {
	return nil, status.Error(codes.Unimplemented, "method FindRegistries not implemented")
}
