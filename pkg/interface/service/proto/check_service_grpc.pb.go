...
func (c *checkServiceClient) SendCode(ctx context.Context, in *SendCheckCodeRequest, opts ...grpc.CallOption) (*SendCheckCodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, CheckService_SendCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *checkServiceClient) GrantAccessToken(ctx context.Context, in *GrantAccessTokenRequest, opts ...grpc.CallOption) (*GrantAccessTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, CheckService_GrantAccessToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *checkServiceClient) CheckAccessToken(ctx context.Context, in *CheckAccessTokenRequest, opts ...grpc.CallOption) (*CheckAccessTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, CheckService_CheckAccessToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCheckServiceServer) ResetCode(context.Context, *ResetCheckCodeRequest) (*ResetCheckCodeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResetCode not implemented")
}
func (UnimplementedCheckServiceServer) GrantAccessToken(context.Context, *GrantAccessTokenRequest) (*GrantAccessTokenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GrantAccessToken not implemented")
}
