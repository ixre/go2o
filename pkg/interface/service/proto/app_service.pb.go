...
const file_app_service_proto_rawDesc = "" +
	"\n" +
	"\x11app_service.proto\x1a\fglobal.proto\"$\n" +
	"\fAppVersionId\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x03R\x05value\"\x96\x01\n" +
	"\x16CheckAppVersionRequest\x12\x18\n" +
	"\aappName\x18\x01 \x01(\tR\aappName\x12\x1e\n" +
	"\n" +
	"terminalOS\x18\x02 \x01(\tR\n" +
	"terminalOS\x12(\n" +
	"\x0fterminalChannel\x18\x03 \x01(\tR\x0fterminalChannel\x12\x18\n" +
	"\aversion\x18\x04 \x01(\tR\aversion\"\x8b\x02\n" +
	"\x17CheckAppVersionResponse\x12$\n" +
	"\rhasNewVersion\x18\x01 \x01(\bR\rhasNewVersion\x12$\n" +
	"\rlatestVersion\x18\x02 \x01(\tR\rlatestVersion\x12\x1e\n" +
	"\n" +
	"packageUrl\x18\x03 \x01(\tR\n" +
	"packageUrl\x12 \n" +
	"\vversionInfo\x18\x04 \x01(\tR\vversionInfo\x12 \n" +
	"\vforceUpdate\x18\x05 \x01(\bR\vforceUpdate\x12\x1e\n" +
	"\n" +
	"updateMode\x18\x06 \x01(\x05R\n" +
	"updateMode\x12 \n" +
	"\vreleaseTime\x18\a \x01(\x03R\vreleaseTime\",\n" +
	"\x14SysAppDistributionId\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x03R\x05value\"\xec\x03\n" +
	"\x10SAppDistribution\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x18\n" +
	"\aappName\x18\x02 \x01(\tR\aappName\x12\x18\n" +
	"\aappIcon\x18\x03 \x01(\tR\aappIcon\x12\x18\n" +
	"\aappDesc\x18\x04 \x01(\tR\aappDesc\x12\x1e\n" +
	"\n" +
	"updateMode\x18\x05 \x01(\x05R\n" +
	"updateMode\x12$\n" +
	"\rdistributeUrl\x18\x06 \x01(\tR\rdistributeUrl\x12&\n" +
	"\x0edistributeName\x18\a \x01(\tR\x0edistributeName\x12$\n" +
	"\rstableVersion\x18\b \x01(\tR\rstableVersion\x12$\n" +
	"\rstableDownUrl\x18\t \x01(\tR\rstableDownUrl\x12 \n" +
	"\vbetaVersion\x18\n" +
	" \x01(\tR\vbetaVersion\x12 \n" +
	"\vbetaDownUrl\x18\v \x01(\tR\vbetaDownUrl\x12\x1e\n" +
	"\n" +
	"iosDownUrl\x18\f \x01(\tR\n" +
	"iosDownUrl\x12\x1c\n" +
	"\turlScheme\x18\r \x01(\tR\turlScheme\x12\x1e\n" +
	"\n" +
	...
	"updateTime\"\xbd\x01\n" +
	"\x11AppVersionRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x1c\n" +
	"\tproductId\x18\x02 \x01(\x03R\tproductId\x12\x18\n" +
	"\achannel\x18\x03 \x01(\x05R\achannel\x12\x18\n" +
	"\aversion\x18\x04 \x01(\tR\aversion\x12 \n" +
	"\vforceUpdate\x18\x05 \x01(\bR\vforceUpdate\x12$\n" +
	"\rupdateContent\x18\x06 \x01(\tR\rupdateContent\"\xc9\x03\n" +
	"\vSAppVersion\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12&\n" +
	"\x0edistributionId\x18\x02 \x01(\x03R\x0edistributionId\x12\x18\n" +
	"\aversion\x18\x03 \x01(\tR\aversion\x12 \n" +
	"\vversionCode\x18\x04 \x01(\x05R\vversionCode\x12\x1e\n" +
	"\n" +
	"terminalOs\x18\x05 \x01(\tR\n" +
	"terminalOs\x12(\n" +
	"\x0fterminalChannel\x18\x06 \x01(\tR\x0fterminalChannel\x12\x1c\n" +
	"\tstartTime\x18\a \x01(\x03R\tstartTime\x12\x1e\n" +
	"\n" +
	"updateMode\x18\b \x01(\x05R\n" +
	"updateMode\x12$\n" +
	"\rupdateContent\x18\t \x01(\tR\rupdateContent\x12\x1e\n" +
	"\n" +
	"packageUrl\x18\n" +
	" \x01(\tR\n" +
	"packageUrl\x12\x18\n" +
	"\aisForce\x18\v \x01(\x05R\aisForce\x12\x1e\n" +
	"\n" +
	"isNotified\x18\f \x01(\x05R\n" +
	"isNotified\x12\x1e\n" +
	"\n" +
	...
	"\n" +
	"AppService\x123\n" +
	"\x13SaveAppDistribution\x12\x11.SAppDistribution\x1a\t.TxResult\x12>\n" +
	"\x12GetAppDistribution\x12\x15.SysAppDistributionId\x1a\x11.SAppDistribution\x129\n" +
	"\x15DeleteAppDistribution\x12\x15.SysAppDistributionId\x1a\t.TxResult\x12)\n" +
	"\x0eSaveAppVersion\x12\f.SAppVersion\x1a\t.TxResult\x12,\n" +
	"\rGetAppVersion\x12\r.AppVersionId\x1a\f.SAppVersion\x12,\n" +
	"\x10DeleteAppVersion\x12\r.AppVersionId\x1a\t.TxResult\x12D\n" +
	"\x0fCheckAppVersion\x12\x17.CheckAppVersionRequest\x1a\x18.CheckAppVersionResponseB\x1f\n" +
	"\x13com.github.go2o.rpcZ\b./;protob\x06proto3"

var (
	file_app_service_proto_rawDescOnce sync.Once
	file_app_service_proto_rawDescData []byte
)

func file_app_service_proto_rawDescGZIP() []byte {
	file_app_service_proto_rawDescOnce.Do(func() {
		file_app_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_app_service_proto_rawDesc), len(file_app_service_proto_rawDesc)))
	})
