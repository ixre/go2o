...
const file_message_member_query_dto_proto_rawDesc = "" +
	"\n" +
	"\x1emessage/member_query_dto.proto\"\xab\x03\n" +
	"\aSMember\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x12R\x02id\x12\x1a\n" +
	"\buserCode\x18\x02 \x01(\tR\buserCode\x12\x1a\n" +
	"\buserFlag\x18\x03 \x01(\x11R\buserFlag\x12\x12\n" +
	"\x04role\x18\x04 \x01(\x11R\x04role\x12\x1a\n" +
	"\busername\x18\x05 \x01(\tR\busername\x12\x14\n" +
	"\x05level\x18\x06 \x01(\x11R\x05level\x12 \n" +
	"\vcountryCode\x18\a \x01(\tR\vcountryCode\x12\"\n" +
	"\fprofilePhoto\x18\b \x01(\tR\fprofilePhoto\x12\x1a\n" +
	"\bnickname\x18\t \x01(\tR\bnickname\x12\x14\n" +
	"\x05phone\x18\n" +
	" \x01(\tR\x05phone\x12\x14\n" +
	"\x05email\x18\v \x01(\tR\x05email\x12\x1a\n" +
	"\brealName\x18\f \x01(\tR\brealName\x12 \n" +
	"\vpremiumUser\x18\r \x01(\x11R\vpremiumUser\x12&\n" +
	"\x0epremiumExpires\x18\x0e \x01(\x12R\x0epremiumExpires\x12\x1e\n" +
	"\n" +
	"createTime\x18\x0f \x01(\x03R\n" +
	"createTime\"\x8a\x04\n" +
	"\bSProfile\x12\x1a\n" +
	"\bmemberId\x18\x01 \x01(\x12R\bmemberId\x12\x1a\n" +
	"\bnickname\x18\x02 \x01(\tR\bnickname\x12\"\n" +
	"\fprofilePhoto\x18\x03 \x01(\tR\fprofilePhoto\x12\x16\n" +
	"\x06gender\x18\x04 \x01(\x11R\x06gender\x12\x1a\n" +
	"\bbirthday\x18\x05 \x01(\tR\bbirthday\x12\x14\n" +
	"\x05phone\x18\x06 \x01(\tR\x05phone\x12\x18\n" +
	"\aaddress\x18\a \x01(\tR\aaddress\x12\x0e\n" +
	"\x02im\x18\b \x01(\tR\x02im\x12\x14\n" +
	"\x05email\x18\t \x01(\tR\x05email\x12\x1a\n" +
	"\bprovince\x18\n" +
	" \x01(\x11R\bprovince\x12\x12\n" +
	"\x04city\x18\v \x01(\x11R\x04city\x12\x1a\n" +
	"\bdistrict\x18\f \x01(\x11R\bdistrict\x12\x16\n" +
	"\x06remark\x18\r \x01(\tR\x06remark\x12\x12\n" +
	...
	"\x04ext5\x18\x12 \x01(\tR\x04ext5\x12\x12\n" +
	"\x04ext6\x18\x13 \x01(\tR\x04ext6\x12\x1e\n" +
	"\n" +
	"updateTime\x18\x14 \x01(\x12R\n" +
	"updateTime\x12\x1c\n" +
	"\tsignature\x18\x15 \x01(\tR\tsignature\"\xf8\x02\n" +
	"\x0eSComplexMember\x12\x1a\n" +
	"\bnickname\x18\x01 \x01(\tR\bnickname\x12\"\n" +
	"\fprofilePhoto\x18\x02 \x01(\tR\fprofilePhoto\x12\x14\n" +
	"\x05phone\x18\x03 \x01(\tR\x05phone\x12\x10\n" +
	"\x03exp\x18\x04 \x01(\x11R\x03exp\x12\x14\n" +
	"\x05level\x18\x05 \x01(\x11R\x05level\x12\x1c\n" +
	"\tlevelName\x18\x06 \x01(\tR\tlevelName\x12\x1a\n" +
	"\buserCode\x18\a \x01(\tR\buserCode\x12&\n" +
	"\x0etrustAuthState\x18\b \x01(\x11R\x0etrustAuthState\x12 \n" +
	"\vpremiumUser\x18\t \x01(\x11R\vpremiumUser\x12\x12\n" +
	"\x04flag\x18\n" +
	" \x01(\x11R\x04flag\x12\x1e\n" +
	"\n" +
	"updateTime\x18\v \x01(\x12R\n" +
	"updateTime\x120\n" +
	"\x13tradePasswordHasSet\x18\f \x01(\bR\x13tradePasswordHasSetB\x1f\n" +
	"\x13com.github.go2o.rpcZ\b./;protob\x06proto3"

var (
	file_message_member_query_dto_proto_rawDescOnce sync.Once
	file_message_member_query_dto_proto_rawDescData []byte
)

func file_message_member_query_dto_proto_rawDescGZIP() []byte {
	file_message_member_query_dto_proto_rawDescOnce.Do(func() {
		file_message_member_query_dto_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_message_member_query_dto_proto_rawDesc), len(file_message_member_query_dto_proto_rawDesc)))
	})
...
var file_message_member_query_dto_proto_goTypes = []any{
...
func file_message_member_query_dto_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_message_member_query_dto_proto_rawDesc), len(file_message_member_query_dto_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
