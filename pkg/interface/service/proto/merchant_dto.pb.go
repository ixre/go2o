...
type QAuthenticate struct {
	...
	// 扩展数据
	ExtraData map[string]string `protobuf:"bytes,19,rep,name=extraData,proto3" json:"extraData" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// 更新时间
...
type SyncWSItemsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Value         map[string]int32       `protobuf:"bytes,1,rep,name=value,proto3" json:"value" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"zigzag32,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_message_merchant_dto_proto_rawDesc = "" +
	"\n" +
	"\x1amessage/merchant_dto.proto\"\x8d\x02\n" +
	"\x13SSaveMerchantParams\x12\x18\n" +
	"\amchName\x18\x01 \x01(\tR\amchName\x12\x1a\n" +
	...
	"\x04city\x18\x06 \x01(\x05R\x04city\x12\x1a\n" +
	"\bdistrict\x18\a \x01(\x05R\bdistrict\x12\x18\n" +
	"\aaddress\x18\b \x01(\tR\aaddress\x12\x12\n" +
	"\x04logo\x18\t \x01(\tR\x04logo\x12\x1c\n" +
	"\ttelephone\x18\n" +
	" \x01(\tR\ttelephone\"\xf7\x05\n" +
	"\x17SaveAuthenticateRequest\x12\x14\n" +
	"\x05mchId\x18\x01 \x01(\x03R\x05mchId\x12\x18\n" +
	"\amchName\x18\x02 \x01(\tR\amchName\x12\x1a\n" +
	"\bprovince\x18\x03 \x01(\x05R\bprovince\x12\x12\n" +
	"\x04city\x18\x04 \x01(\x05R\x04city\x12\x1a\n" +
	"\bdistrict\x18\x05 \x01(\x05R\bdistrict\x12\x18\n" +
	"\aorgName\x18\x06 \x01(\tR\aorgName\x12\x14\n" +
	"\x05orgNo\x18\a \x01(\tR\x05orgNo\x12\x16\n" +
	"\x06orgPic\x18\b \x01(\tR\x06orgPic\x12\x1e\n" +
	"\n" +
	"orgAddress\x18\t \x01(\tR\n" +
	"orgAddress\x12\x1a\n" +
	"\bworkCity\x18\x15 \x01(\x05R\bworkCity\x12*\n" +
	"\x10qualificationPic\x18\n" +
	" \x01(\tR\x10qualificationPic\x12\x1a\n" +
	"\bpersonId\x18\v \x01(\tR\bpersonId\x12\x1e\n" +
	"\n" +
	"personName\x18\f \x01(\tR\n" +
	"personName\x12&\n" +
	"\x0epersonFrontPic\x18\r \x01(\tR\x0epersonFrontPic\x12$\n" +
	"\rpersonBackPic\x18\x0e \x01(\tR\rpersonBackPic\x12&\n" +
	"\x0ebankAccountPic\x18\x16 \x01(\tR\x0ebankAccountPic\x12\"\n" +
	"\fauthorityPic\x18\x0f \x01(\tR\fauthorityPic\x12\x1a\n" +
	"\bbankName\x18\x10 \x01(\tR\bbankName\x12 \n" +
	"\vbankAccount\x18\x11 \x01(\tR\vbankAccount\x12\x16\n" +
	"\x06bankNo\x18\x12 \x01(\tR\x06bankNo\x12\x1c\n" +
	"\textraData\x18\x13 \x01(\tR\textraData\x12 \n" +
	"\vpersonPhone\x18\x14 \x01(\tR\vpersonPhone\x12 \n" +
	"\vcontactName\x18\x17 \x01(\tR\vcontactName\x12\"\n" +
	"\fcontactPhone\x18\x18 \x01(\tR\fcontactPhone\"\x8f\x01\n" +
	"\x15CreateMerchantRequest\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\bmemberId\x18\x02 \x01(\x03R\bmemberId\x12\x16\n" +
	"\x06isSelf\x18\x03 \x01(\x05R\x06isSelf\x12&\n" +
	"\x03mch\x18\x04 \x01(\v2\x14.SSaveMerchantParamsR\x03mch\"j\n" +
	"\x16MerchantCreateResponse\x12\x18\n" +
	"\aerrCode\x18\x01 \x01(\x05R\aerrCode\x12\x16\n" +
	"\x06errMsg\x18\x02 \x01(\tR\x06errMsg\x12\x1e\n" +
	"\n" +
	"merchantId\x18\x03 \x01(\x03R\n" +
	"merchantId\"S\n" +
	"\x13SaveMerchantRequest\x12\x14\n" +
	"\x05mchId\x18\x01 \x01(\x03R\x05mchId\x12&\n" +
	"\x03mch\x18\x04 \x01(\v2\x14.SSaveMerchantParamsR\x03mch\"\x9d\x04\n" +
	"\tQMerchant\x12\x14\n" +
	"\x05mchId\x18\x01 \x01(\x03R\x05mchId\x12\x18\n" +
	"\amchName\x18\x02 \x01(\tR\amchName\x12\x1a\n" +
	"\bmemberId\x18\x03 \x01(\x03R\bmemberId\x12\x1a\n" +
	"\busername\x18\x04 \x01(\tR\busername\x12\x1a\n" +
	"\bmailAddr\x18\x05 \x01(\tR\bmailAddr\x12\x16\n" +
	"\x06isSelf\x18\x06 \x01(\x05R\x06isSelf\x12\x12\n" +
	"\x04flag\x18\a \x01(\x05R\x04flag\x12\x14\n" +
	"\x05level\x18\b \x01(\x05R\x05level\x12\x1a\n" +
	"\bprovince\x18\t \x01(\x05R\bprovince\x12\x12\n" +
	"\x04city\x18\n" +
	" \x01(\x05R\x04city\x12\x1a\n" +
	"\bdistrict\x18\v \x01(\x05R\bdistrict\x12\x18\n" +
	"\aaddress\x18\f \x01(\tR\aaddress\x12\x12\n" +
	"\x04logo\x18\r \x01(\tR\x04logo\x12\x1c\n" +
	"\ttelephone\x18\x0e \x01(\tR\ttelephone\x12\x16\n" +
	"\x06status\x18\x0f \x01(\x05R\x06status\x12 \n" +
	"\vexpiresTime\x18\x10 \x01(\x03R\vexpiresTime\x12$\n" +
	"\rlastLoginTime\x18\x11 \x01(\x03R\rlastLoginTime\x12\x1e\n" +
	"\n" +
	"createTime\x18\x12 \x01(\x03R\n" +
	"createTime\x122\n" +
	"\fauthenticate\x18\x13 \x01(\v2\x0e.QAuthenticateR\fauthenticate\"\xf0\x05\n" +
	"\rQAuthenticate\x12\x18\n" +
	"\aorgName\x18\x01 \x01(\tR\aorgName\x12\x14\n" +
	"\x05orgNo\x18\x02 \x01(\tR\x05orgNo\x12\x16\n" +
	"\x06orgPic\x18\x03 \x01(\tR\x06orgPic\x12\x1a\n" +
	"\bworkCity\x18\x06 \x01(\x05R\bworkCity\x12*\n" +
	"\x10qualificationPic\x18\a \x01(\tR\x10qualificationPic\x12\x1a\n" +
	"\bpersonId\x18\b \x01(\tR\bpersonId\x12\x1e\n" +
	"\n" +
	"personName\x18\t \x01(\tR\n" +
	"personName\x12&\n" +
	"\x0epersonFrontPic\x18\n" +
	" \x01(\tR\x0epersonFrontPic\x12$\n" +
	"\rpersonBackPic\x18\x15 \x01(\tR\rpersonBackPic\x12&\n" +
	"\x0ebankAccountPic\x18\x16 \x01(\tR\x0ebankAccountPic\x12 \n" +
	"\vpersonPhone\x18\v \x01(\tR\vpersonPhone\x12\"\n" +
	"\fauthorityPic\x18\f \x01(\tR\fauthorityPic\x12\x1a\n" +
	"\bbankName\x18\r \x01(\tR\bbankName\x12 \n" +
	"\vbankAccount\x18\x0e \x01(\tR\vbankAccount\x12\x16\n" +
	"\x06bankNo\x18\x0f \x01(\tR\x06bankNo\x12\x1e\n" +
	"\n" +
	"reviewTime\x18\x10 \x01(\x05R\n" +
	"reviewTime\x12\"\n" +
	"\freviewStatus\x18\x11 \x01(\x05R\freviewStatus\x12\"\n" +
	"\freviewRemark\x18\x12 \x01(\tR\freviewRemark\x12;\n" +
	"\textraData\x18\x13 \x03(\v2\x1d.QAuthenticate.ExtraDataEntryR\textraData\x12\x1e\n" +
	"\n" +
	...
	"\x17ChangeMemberBindRequest\x12\x1e\n" +
	"\n" +
	"merchantId\x18\x01 \x01(\x03R\n" +
	"merchantId\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\"K\n" +
	"\x11MchUserPwdRequest\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\"|\n" +
	"\x10MchLoginResponse\x12\x18\n" +
	"\aerrCode\x18\x01 \x01(\x05R\aerrCode\x12\x16\n" +
	"\x06errMsg\x18\x02 \x01(\tR\x06errMsg\x12\x1e\n" +
	"\n" +
	"merchantId\x18\x03 \x01(\x03R\n" +
	"merchantId\x12\x16\n" +
	"\x06shopId\x18\x04 \x01(\x03R\x06shopId\"\x86\x01\n" +
	"\x13SyncWSItemsResponse\x125\n" +
	"\x05value\x18\x01 \x03(\v2\x1f.SyncWSItemsResponse.ValueEntryR\x05value\x1a8\n" +
	"\n" +
	"ValueEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x11R\x05value:\x028\x01\"<\n" +
	"\x16STradeConfListResponse\x12\"\n" +
	"\x05value\x18\x01 \x03(\v2\f.STradeConf_R\x05value\"F\n" +
	"\x10TradeConfRequest\x12\x14\n" +
	"\x05mchId\x18\x01 \x01(\x11R\x05mchId\x12\x1c\n" +
	"\ttradeType\x18\x02 \x01(\x11R\ttradeType\"L\n" +
	"\x14TradeConfSaveRequest\x12\x14\n" +
	"\x05mchId\x18\x01 \x01(\x11R\x05mchId\x12\x1e\n" +
	"\x03arr\x18\x02 \x03(\v2\f.STradeConf_R\x03arr\"\r\n" +
	"\vSTradeConf_\"Y\n" +
	"\x15MerchantReviewRequest\x12\x14\n" +
	"\x05mchId\x18\x01 \x01(\x03R\x05mchId\x12\x12\n" +
	"\x04pass\x18\x02 \x01(\bR\x04pass\x12\x16\n" +
	"\x06remark\x18\x03 \x01(\tR\x06remark\"\xfc\x02\n" +
	"\x10SMerchantAccount\x12\x18\n" +
	"\abalance\x18\x01 \x01(\x03R\abalance\x12\"\n" +
	"\ffreezeAmount\x18\x02 \x01(\x03R\ffreezeAmount\x12 \n" +
	"\vawaitAmount\x18\x03 \x01(\x03R\vawaitAmount\x12$\n" +
	"\rpresentAmount\x18\x04 \x01(\x03R\rpresentAmount\x12 \n" +
	"\vsalesAmount\x18\x05 \x01(\x03R\vsalesAmount\x12\"\n" +
	"\frefundAmount\x18\x06 \x01(\x03R\frefundAmount\x12*\n" +
	"\x10withdrawalAmount\x18\a \x01(\x03R\x10withdrawalAmount\x12,\n" +
	"\x11invoiceableAmount\x18\b \x01(\x03R\x11invoiceableAmount\x12\"\n" +
	"\fofflineSales\x18\t \x01(\x03R\fofflineSales\x12\x1e\n" +
	"\n" +
	"updateTime\x18\n" +
	" \x01(\x03R\n" +
	"updateTime\"O\n" +
	"\x19MerchantLockStatusRequest\x12\x1e\n" +
	"\n" +
	"merchantId\x18\x01 \x01(\x03R\n" +
	"merchantId\x12\x12\n" +
	"\x04lock\x18\x02 \x01(\bR\x04lock\"\xe7\x03\n" +
	"\x11SMerchantSaleConf\x12\x1e\n" +
	"\n" +
	"merchantId\x18\x01 \x01(\x03R\n" +
	"merchantId\x12&\n" +
	"\x0efxSalesEnabled\x18\x02 \x01(\bR\x0efxSalesEnabled\x12(\n" +
	"\x0fcashBackPercent\x18\x03 \x01(\x01R\x0fcashBackPercent\x12.\n" +
	"\x12cashBackTg1Percent\x18\x04 \x01(\x01R\x12cashBackTg1Percent\x12.\n" +
	"\x12cashBackTg2Percent\x18\x05 \x01(\x01R\x12cashBackTg2Percent\x124\n" +
	"\x15cashBackMemberPercent\x18\x06 \x01(\x01R\x15cashBackMemberPercent\x12&\n" +
	"\x0eautoSetupOrder\x18\a \x01(\bR\x0eautoSetupOrder\x12.\n" +
	"\x12orderTimeOutMinute\x18\b \x01(\x05R\x12orderTimeOutMinute\x128\n" +
	"\x17orderConfirmAfterMinute\x18\t \x01(\x05R\x17orderConfirmAfterMinute\x128\n" +
	"\x17orderTimeOutReceiveHour\x18\n" +
	" \x01(\x05R\x17orderTimeOutReceiveHour\"g\n" +
	"\x1bSaveMerchantSaleConfRequest\x12\x1e\n" +
	"\n" +
	"merchantId\x18\x01 \x01(\x03R\n" +
	"merchantId\x12(\n" +
	"\x05value\x18\x02 \x01(\v2\x12.SMerchantSaleConfR\x05value\"\x83\x01\n" +
	"\x1dModifyMerchantPasswordRequest\x12\x1e\n" +
	"\n" +
	"merchantId\x18\x01 \x01(\x03R\n" +
	"merchantId\x12 \n" +
	"\voldPassword\x18\x02 \x01(\tR\voldPassword\x12 \n" +
	"\vnewPassword\x18\x03 \x01(\tR\vnewPassword\"~\n" +
	"\x10SMerchantApiInfo\x12\x14\n" +
	"\x05apiId\x18\x01 \x01(\tR\x05apiId\x12\x1c\n" +
	"\tapiSecret\x18\x02 \x01(\tR\tapiSecret\x12\x1c\n" +
	"\twhiteList\x18\x03 \x03(\tR\twhiteList\x12\x18\n" +
	"\aenabled\x18\x04 \x01(\bR\aenabled\"R\n" +
	"\x16MerchantApiPermRequest\x12\x1e\n" +
	"\n" +
	"merchantId\x18\x01 \x01(\x03R\n" +
	"merchantId\x12\x18\n" +
	"\aenabled\x18\x04 \x01(\bR\aenabled\"X\n" +
	"\x1eWithdrawToMemberAccountRequest\x12\x1e\n" +
	"\n" +
	"merchantId\x18\x01 \x01(\x03R\n" +
	"merchantId\x12\x16\n" +
	"\x06amount\x18\x02 \x01(\x03R\x06amount\"P\n" +
	"\x14MerchantBuyerGroupId\x12\x1e\n" +
	"\n" +
	"merchantId\x18\x01 \x01(\x03R\n" +
	"merchantId\x12\x18\n" +
	"\agroupId\x18\x02 \x01(\x03R\agroupId\"k\n" +
	"\x1dSaveMerchantBuyerGroupRequest\x12\x1e\n" +
	"\n" +
	"merchantId\x18\x01 \x01(\x03R\n" +
	"merchantId\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.SMerchantBuyerGroupR\x05value\"L\n" +
	"\x1eMerchantBuyerGroupListResponse\x12*\n" +
	"\x05value\x18\x01 \x03(\v2\x14.SMerchantBuyerGroupR\x05value\"\xc5\x01\n" +
	"\x13SMerchantBuyerGroup\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x18\n" +
	"\agroupId\x18\x02 \x01(\x03R\agroupId\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\"\n" +
	"\fenableRetail\x18\x04 \x01(\bR\fenableRetail\x12(\n" +
	"\x0fenableWholesale\x18\x05 \x01(\bR\x0fenableWholesale\x12\"\n" +
	"\frebatePeriod\x18\x06 \x01(\x05R\frebatePeriod\"\x87\x01\n" +
	"\x1eSaveWholesaleRebateRateRequest\x12\x1e\n" +
	"\n" +
	"merchantId\x18\x01 \x01(\x03R\n" +
	"merchantId\x12\x18\n" +
	"\agroupId\x18\x02 \x01(\x03R\agroupId\x12+\n" +
	"\x05value\x18\x03 \x03(\v2\x15.SWholesaleRebateRateR\x05value\"N\n" +
	"\x1fWholesaleRebateRateListResponse\x12+\n" +
	"\x05value\x18\x01 \x03(\v2\x15.SWholesaleRebateRateR\x05value\"\xa4\x01\n" +
	"\x14SWholesaleRebateRate\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x12\n" +
	"\x04wsId\x18\x02 \x01(\x03R\x04wsId\x12\"\n" +
	"\fbuyerGroupId\x18\x03 \x01(\x03R\fbuyerGroupId\x12$\n" +
	"\rrequireAmount\x18\x04 \x01(\x05R\rrequireAmount\x12\x1e\n" +
	"\n" +
	"rebateRate\x18\x05 \x01(\x01R\n" +
	"rebateRateB\x1f\n" +
	"\x13com.github.go2o.rpcZ\b./;protob\x06proto3"

var (
	file_message_merchant_dto_proto_rawDescOnce sync.Once
	file_message_merchant_dto_proto_rawDescData []byte
)

func file_message_merchant_dto_proto_rawDescGZIP() []byte {
	file_message_merchant_dto_proto_rawDescOnce.Do(func() {
		file_message_merchant_dto_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_message_merchant_dto_proto_rawDesc), len(file_message_merchant_dto_proto_rawDesc)))
	})
...
var file_message_merchant_dto_proto_goTypes = []any{
...
func file_message_merchant_dto_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_message_merchant_dto_proto_rawDesc), len(file_message_merchant_dto_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   33,
			NumExtensions: 0,
			NumServices:   0,
